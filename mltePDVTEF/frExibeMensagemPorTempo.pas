...
type
  ...
  TFormExibeMensagemPorTempo = class(TForm)
    btOk: TButton;
    lMensagem: TLabel;
    pMensagem: TPanel;
    tEspera: TTimer;
...
procedure TFormExibeMensagemPorTempo.FormShow(Sender: TObject);
begin
...
procedure TFormExibeMensagemPorTempo.FormClick(Sender: TObject);
begin
  AbortarTempoEspera;
end;

procedure TFormExibeMensagemPorTempo.lMensagemClick(Sender: TObject);
begin
  AbortarTempoEspera;
end;

procedure TFormExibeMensagemPorTempo.tEsperaTimer(Sender: TObject);
var
...
function TFormExibeMensagemPorTempo.GetMensagem: String;
begin
  Result := lMensagem.Caption;
end;

procedure TFormExibeMensagemPorTempo.SetMensagem(AValue: String);
var
...
procedure TFormExibeMensagemPorTempo.AbortarTempoEspera;
begin
  tEspera.Enabled := False;
  btOk.Caption := 'OK';
end;
