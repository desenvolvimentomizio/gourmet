inherited fracre: Tfracre
        ...
        inherited PnlRodapeGrid: TPanel
          ...
          inherited PlDetalhe: TPanel
            ...
            inherited GbGeral: TGroupBox
              ...
              Top = 2
              Align = alLeft
              Caption = 'A Receber  C/Juros R$'
              ExplicitLeft = 367
              ExplicitTop = 2
              inherited pltotalGeral: TPanel
                Font.Height = -13
              end
            end
            ...
            inherited GBPrincipal: TGroupBox
              ...
              Caption = 'A Receber R$'
              ExplicitLeft = 122
              inherited plvencidovencido: TPanel
                Font.Height = -13
              end
            end
            inherited gbjurosvencido: TGroupBox
              Left = 267
              Align = alLeft
              ExplicitLeft = 267
              inherited pljurosvencido: TPanel
                Font.Height = -13
              end
            end
  ...
  inherited MenuManutencao: TPopupMenu
    object mUtiliatarios: TMenuItem
      ...
      object AjustarCentrodeCusto1: TMenuItem
        Caption = 'Ajustar Centro de Custo'
        OnClick = AjustarCentrodeCusto1Click
      end
    end
  end
  inherited uqtabela: TUniQuery
    SQL.Strings = (
      ...
      '     left JOIN clb ON mes.clbvendedor=clb.clbcodigo'
    ...
    object uqtabelaorcchave: TIntegerField [37]
      DisplayLabel = 'N'#186' Atendimento'
      FieldName = 'orcchave'
    end
    object uqtabelaclbvendedor: TIntegerField [38]
      DisplayLabel = 'Cod. Vendedor'
      FieldName = 'clbvendedor'
    end
    object uqtabelarfiinclusao: TDateTimeField [39]
  ...
  inherited mfi: TUniQuery
    SQL.Strings = (
      ...
      'AND rfichave = :rfichave and mfi.tmfcodigo<>50'
  ...
  object edr: TUniQuery
    SQL.Strings = (
      ...
      'if(@edrcodigo=0, tedcodigo=1, edr.edrcodigo=@edrcodigo)')
    Left = 936
    Top = 312
    ParamData = <
      item
  ...
  object qtotais: TUniQuery
    SQL.Strings = (
      ...
      '      mfivalor'
      '    FROM mfi m'
      '    WHERE m.rfichave = rfi.rfichave'
      '    AND tmfcodigo IN (21)'
      '    ORDER BY mfichave DESC LIMIT 1) mfivalor,'
      '  (SELECT'
      '      mfivalor'
      '    FROM mfi m'
      '    WHERE m.rfichave = rfi.rfichave'
      '    AND tmfcodigo IN (22)'
      '    ORDER BY mfichave DESC LIMIT 1) rebjuros,'
      '  (SELECT'
      '      mfivalor'
      '    FROM mfi m'
      '    WHERE m.rfichave = rfi.rfichave'
      '    AND tmfcodigo IN (23)'
      '    ORDER BY mfichave DESC LIMIT 1) multa,'
      '  (SELECT'
      '      mfivalor'
      '    FROM mfi m'
      '    WHERE m.rfichave = rfi.rfichave'
      '    AND tmfcodigo IN (4, 50)'
      '    ORDER BY mfichave DESC LIMIT 1) desconto,'
      '  lte.ctacodigo,'
      '  ctaidentificacao,'
      '  dtl.mdacodigo,'
      '  mdaidentificacao,'
      ...
      'AND rfi.tfdcodigo = 2'
      'AND rfi.srfcodigo IN (1, 2)'
      'AND mfi.tmfcodigo NOT IN (28, 29)'
      'GROUP BY ctaidentificacao,'
      '         rfi.rfichave)'
      ''
      ''
      'UNION ALL'
      ...
      'AND mfi.tmfcodigo IN (21)'
      'AND rfi.srfcodigo IN (3))'
      ' ORDER BY  ctaidentificacao, rfidtultbaixa,etdidentificacao'
      ' -- filtros')
    Left = 416
    Top = 537
    ParamData = <
    ...
    object qtotaisrfichave: TIntegerField
      FieldName = 'rfichave'
      ReadOnly = True
      Required = True
    end
    object qtotaisetdidentificacao: TStringField
      FieldName = 'etdidentificacao'
      ReadOnly = True
      Size = 180
    end
    object qtotaisrfivencimento: TDateField
      FieldName = 'rfivencimento'
      ReadOnly = True
    end
    object qtotaisrfivalor: TFloatField
      FieldName = 'rfivalor'
      ReadOnly = True
      Required = True
    end
    object qtotaissrfidentificacao: TStringField
      FieldName = 'srfidentificacao'
      ReadOnly = True
      Size = 50
    end
    object qtotaisrfidtultbaixa: TDateField
      FieldName = 'rfidtultbaixa'
      ReadOnly = True
    end
    object qtotaismfivalor: TFloatField
      FieldName = 'mfivalor'
      ReadOnly = True
    end
    object qtotaisrebjuros: TFloatField
      FieldName = 'rebjuros'
      ReadOnly = True
    end
    object qtotaismulta: TFloatField
      FieldName = 'multa'
      ReadOnly = True
    end
    object qtotaisdesconto: TFloatField
      FieldName = 'desconto'
      ReadOnly = True
    end
    object qtotaisctacodigo: TIntegerField
      FieldName = 'ctacodigo'
      ReadOnly = True
    end
    object qtotaisctaidentificacao: TStringField
      FieldName = 'ctaidentificacao'
      ReadOnly = True
      Required = True
      Size = 50
    end
    object qtotaismdacodigo: TIntegerField
      FieldName = 'mdacodigo'
      ReadOnly = True
    end
    object qtotaismdaidentificacao: TStringField
      FieldName = 'mdaidentificacao'
      ReadOnly = True
      Size = 30
    end
    object qtotaistmfcodigo: TIntegerField
      FieldName = 'tmfcodigo'
    end
  end
