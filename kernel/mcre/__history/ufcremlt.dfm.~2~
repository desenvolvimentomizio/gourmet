inherited fcremlt: Tfcremlt
  ...
  inherited registro: TUniQuery
    ...
    Left = 640
    Top = 188
    object registrocctchave: TIntegerField [34]
      FieldName = 'cctchave'
    end
  end
  ...
  object v_rfi: TUniQuery
    SQL.Strings = (
        ...
        'select rfichave, rfinumero, rfihistorico, rfivencimento,cctchave' +
        ' from v_rfi where rfichave=:rfichave')
    Left = 564
    Top = 256
    ParamData = <
      item
    ...
    object v_rficctchave: TIntegerField
      FieldName = 'cctchave'
    end
  end
