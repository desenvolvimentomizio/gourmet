inherited framfi: Tframfi
      ...
      inherited PnlGrid: TPanel
        ...
        object GBLote: TGroupBox
          ...
          object novadata: TDateTimePicker
            ...
            Width = 115
            Height = 24
            Date = 43061.000000000000000000
            Time = 0.802169918977597300
            Enabled = False
            TabOrder = 6
            Visible = False
          end
  ...
  inherited uqtabela: TUniQuery
    SQL.Strings = (
      ...
      ''
      '  left JOIN clb'
      '    ON lte.clbcodigo = clb.clbcodigo'
  ...
  object dtl: TUniQuery
    SQL.Strings = (
      ...
      'AND mda.mdacodigo in (1,2,3,4,5)'
      ''
      'UNION ALL */'
      ''
      'SELECT DISTINCT '
      ...
      'LEFT JOIN lcv ON lte.ltechave = lcv.ltechave'
      'LEFT JOIN mcr ON lcv.mcrchave = mcr.mcrchave'
      'LEFT JOIN rcr ON mcr.rcrchave = rcr.rcrchave'
