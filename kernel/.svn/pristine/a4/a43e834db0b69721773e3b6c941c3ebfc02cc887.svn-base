...
function RecebCaixa(pCargaFrame: TCargaFrame; Conexao: TUniConnection; acesso: Tacesso; pCtaCodigo: Integer; pEtdCodigo: String;
...
begin
  ...
  try
    ...
    lbrr.frabrr.vpccxchave := pCcxchave;
