inherited frfimlt: Tfrfimlt
  ActiveControl = etdcodigo
  Caption = 'Registro de v'#225'rias parcelas'
  ClientHeight = 473
  ClientWidth = 944
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited paginas: TPageControl
    ...
    inherited Principal: TTabSheet
      ...
      object ltitvalor: TLabel
        Left = 9
        Top = 249
        Width = 137
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Soma de TODAS parcelas R$'
      ...
      object Label16: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Este registro '#233' uma previs'#227'o'
        FocusControl = titprevisao
      end
      ...
      object BGerarRepeticoes: TBitBtn
        Left = 577
        Top = 381
        Width = 97
        Height = 21
        ...
        TabOrder = 20
        Visible = False
        OnClick = BGerarRepeticoesClick
      end
      object titparcelas: TDBEdit
        Left = 152
        Top = 192
        Width = 30
        Height = 21
        CustomHint = BalloonHint
        DataField = 'titparcelas'
        DataSource = DSRegistro
        TabOrder = 8
        OnEnter = titparcelasEnter
        OnExit = titparcelasExit
      end
      ...
      object titprevisao: TDBEdit
        Left = 152
        Top = 381
        Width = 29
        Height = 21
        CustomHint = BalloonHint
        DataField = 'titprevisao'
        DataSource = DSRegistro
        TabOrder = 19
      end
  ...
  inherited cfg: TUniQuery
    SQL.Strings = (
        ...
        'select cfgdtinictb, cfgdtfinctb from cfg where flacodigo=:flacod' +
        'igo')
    Left = 444
    Top = 12
    ParamData = <
  ...
  inherited registro: TUniQuery
    ...
    object registrotitinclusao: TDateTimeField
      FieldName = 'titinclusao'
    end
  ...
  object rfi: TUniQuery
    ...
    object rfirfiinclusao: TDateTimeField
      FieldName = 'rfiinclusao'
    end
    object rfitngcodigo: TIntegerField
      FieldName = 'tngcodigo'
    end
    object rficctchave: TIntegerField
      FieldName = 'cctchave'
    end
  end
