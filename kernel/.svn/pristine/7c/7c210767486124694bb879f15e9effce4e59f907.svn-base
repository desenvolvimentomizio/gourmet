      ...
      begin
        ...
        begin
          ...
          begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    if (uqtabelaimecodigo.AsString <> '') and (uqtabelaimecodigo.AsString <> punpunbarra.AsString) and
                      (uqtabelaimecodigo.AsString <> punpuncodigo.AsString) and (uqtabelaimecodigo.AsString <> 'PENDENTE') then
                    begin
            ...
            consulta.close;
            consulta.SQL.Text := 'select procodigo, proenvioimendes from pro where  procodigo=' + uqtabelaprocodigo.AsString;
            consulta.Open;

            if not consulta.IsEmpty then

            begin
              if consulta.FieldByName('proenvioimendes').AsString = '' then
              begin
                consulta.Edit;
                consulta.FieldByName('proenvioimendes').AsDateTime := now();
                consulta.Post;
              end;
            end;
...
begin
  ...
  begin
    ...
    begin
      imu.Append;
      imuimudtultcons.AsString := datetostr(now());
    end
    else
    begin
      imu.Edit;
  ...
  begin
    ...
    if lowercase(imuimusimbpdv.AsString) = 'f' then
    begin
      imuimupercredbcicms.AsFloat := 0;
      imuimupercicms.AsFloat := 0;
      imuimuicmspdv.AsFloat := 0;
      imuimupercfcp.AsFloat := 0;
    end;
    ...
    if imuimudtrev.AsString = '' then
    begin
      imuimudtrev.AsString := datetostr(now());
    end;

    consulta.close;
    consulta.SQL.Text := 'select procodigo, proretornoimendes from pro where  procodigo=' + uqtabelaprocodigo.AsString;
    consulta.Open;

    if not consulta.IsEmpty then
    begin
      if consulta.FieldByName('proretornoimendes').AsString = '' then
      begin
        consulta.Edit;
        consulta.FieldByName('proretornoimendes').AsDateTime := now();
        consulta.Post;
      end;
    end;
