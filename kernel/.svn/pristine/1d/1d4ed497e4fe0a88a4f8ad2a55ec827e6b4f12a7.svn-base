      ...
      Begin
        ...
        begin
          ...
          if not Renegociacao then
            vRetBaixa := Registra(Application, zcone, vchave, '1', Vpri, vmulta, Vjur, Vdes, acesso, vmodo, diabaixa.Date, vPodeConvenio, 0, 0, vPodeCartoes,  RecebCaixa.Conta, False,false, vpccxchave)
          else
