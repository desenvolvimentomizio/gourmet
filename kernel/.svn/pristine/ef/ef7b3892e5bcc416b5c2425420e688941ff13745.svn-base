inherited fajustatngcre: Tfajustatngcre
  ActiveControl = tngcodigo
  Caption = 'Ajuste de N'#250'cleo Gerencial'
  ClientHeight = 122
  ClientWidth = 633
  ExplicitWidth = 649
  ExplicitHeight = 161
  ...
  inherited registro: TUniQuery
    SQL.Strings = (
      'select titcodigo, tngcodigo from tit where titcodigo=:titcodigo')
    ParamData = <
      item
        DataType = ftUnknown
        Name = 'titcodigo'
