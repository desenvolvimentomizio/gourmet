inherited fspd: Tfspd
  ...
  inherited paginas: TPageControl
    ...
    inherited Principal: TTabSheet
      ...
      object Label6: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Conta Cont'#225'bil de Balan'#231'o'
      ...
      object Label7: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Aliquota para Simples Nacional'
        FocusControl = spdaliquotasimples
      end
      ...
      object spdaliquotasimples: TDBEdit
        Left = 180
        Top = 111
        Width = 77
        Height = 21
        CustomHint = BalloonHint
        DataField = 'spdaliquotasimples'
        DataSource = DSRegistro
        TabOrder = 4
      end
    end
  ...
  inherited registro: TUniQuery
    SQL.Strings = (
        ...
        ' spddatabalanco,  pcccodigo, spdativo, spdaliquotasimples from s' +
        'pd where spdchave=:spdchave')
    Left = 388
    Top = 168
    ParamData = <
      item
    ...
    object registrospdaliquotasimples: TFloatField
