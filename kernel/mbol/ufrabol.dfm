inherited frabol: Tfrabol
  ...
  inherited acoes: TActionList
    ...
    object ActMostrarTodos: TAction [14]
  ...
  object obl: TUniQuery
    SQL.Strings = (
      ...
      '  obl.oblnossonume,'
      '  obl.oblnumret,'
      '  tob.tobidentificacao,'
      '  obl.obldatabaixamanual'
      
        'FROM obl, tob where obl.tobcodigo=tob.tobcodigo and bolchave=:bo' +
        'lchave')
    Left = 992
    Top = 325
    ParamData = <
    ...
    object obltobidentificacao: TStringField
    ...
    object obloblvalor: TCurrencyField
      DisplayLabel = 'Valor R$'
      FieldName = 'oblvalor'
    end
    ...
    object oblobldatabaixamanual: TDateField
      DisplayLabel = 'Dt. Baixa Manual'
      FieldName = 'obldatabaixamanual'
    end
  end
  object dsobl: TUniDataSource
    DataSet = obl
    Left = 1032
    Top = 324
  end
