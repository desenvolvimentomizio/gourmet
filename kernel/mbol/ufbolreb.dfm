inherited fbolreb: Tfbolreb
  ...
  object rfi: TUniQuery
    SQL.Strings = (
        ...
        'select rfichave, srfcodigo, rfidtultbaixa,etdcodigo,rfibaixamanu' +
        'al from rfi where rfichave=:rfichave')
    Left = 116
    Top = 104
    ParamData = <
      item
    ...
    object rfirfibaixamanual: TIntegerField
      FieldName = 'rfibaixamanual'
    end
  end
  ...
  object obl: TUniQuery
    ...
    object oblobldatabaixamanual: TDateField
      FieldName = 'obldatabaixamanual'
    end
  end
  ...
  object bol: TUniQuery
    SQL.Strings = (
        ...
        'select bolchave, bolarquivodebaixa, boldatahoraretorno from bol ' +
    ...
    object bolbolarquivodebaixa: TStringField
      FieldName = 'bolarquivodebaixa'
      Size = 250
    end
    object bolboldatahoraretorno: TDateTimeField
      FieldName = 'boldatahoraretorno'
    end
  end
  object tob: TUniQuery
    SQL.Strings = (
      'SELECT'
      '  tobcodigo,'
      '  bcocodigo,'
      ...
      '  tobidentificacao'
        ...
        'FROM tob where bcocodigo=:bcocodigo and tobreferencia=:tobrefere' +
        'ncia')
    Left = 452
    Top = 312
    ParamData = <
