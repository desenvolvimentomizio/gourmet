object fgsp: Tfgsp
  ...
  object pro: TUniQuery
    SQL.Strings = (
      ...
      'AND mes.mesregistro >= :inicio'
      'AND mes.mesregistro <= :final'
      'AND pro.pronome not like ('#39'TAXA DE ENTREGA%'#39')'
      '--  and mes.mesnumero=899968'
  ...
  object mes: TUniQuery
    SQL.Strings = (
      ...
      '  mes.mesregistro,'
        ...
        '  (select sum(itmtotal) from itm,pro where   pro.pronome not lik' +
        'e ('#39'TAXA DE ENTREGA%'#39') and   itm.procodigo=pro.procodigo and pro' +
        '.tpocodigo in (0,1,8,7,10) and itm.meschave=mes.meschave) as mes' +
        'valor,'
      '  mes.tfpcodigo,'
      
        '  (select sum(itmdesconto) from itm,pro where pro.pronome not li' +
        'ke ('#39'TAXA DE ENTREGA%'#39') and itm.procodigo=pro.procodigo and pro.' +
        'tpocodigo in (0,1,7,8,10) and itm.meschave=mes.meschave) mesdesc' +
        'onto,'
      '  mes.mestotal,'
      '   '
      '  mes.mesfrete,'
