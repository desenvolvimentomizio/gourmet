...
type
  Tlclb = class(Tlfrmbase)
    ...
    Dfcl: tunidatasource;
    procedure fraclbActAtualizarExecute(Sender: TObject);
...
procedure Tlclb.FormResize(Sender: TObject);
begin
  inherited;
  try
self.fraclb.DBGLista.SetFocus;
  except

  end;
end;

procedure Tlclb.fraclbActAtualizarExecute(Sender: TObject);
begin
  inherited;
  fraclb.ActAtualizarExecute(Sender);
