inherited fcprsimples: Tfcprsimples
  ...
  inherited pbotoes: TPanel
    ...
    object bsalvarsemprocessar: TButton
      Left = 814
      Top = 4
      Width = 135
      Height = 22
      ...
      Align = alRight
      Caption = 'Salvar sem Processa'
      TabOrder = 4
      Visible = False
      OnClick = bsalvarsemprocessarClick
    end
  ...
  inherited paginas: TPageControl
    ...
    inherited Principal: TTabSheet
      ...
      object GBOutrosCustos: TGroupBox
        Left = 923
        Top = 166
        Width = 105
        Height = 40
  ...
  object Dbuscapro: TUniDataSource [14]
    DataSet = buscapro
    Left = 744
    Top = 308
  end
  ...
  object Dcfg: TUniDataSource [16]
    DataSet = cfg
    Left = 804
    Top = 380
  end
  object spd: TUniQuery [17]
    SQL.Strings = (
  ...
  object Dvitm: TUniDataSource [28]
    DataSet = itm
    Left = 420
    Top = 360
  end
  object acoes: TActionList [29]
  ...
  object Detd: TUniDataSource [30]
    DataSet = etd
    Left = 992
    Top = 28
  end
  object etv: TUniQuery [31]
    SQL.Strings = (
      'select * from etv')
    MasterSource = DSRegistro
  ...
  object ufsetd: TUniQuery [42]
    SQL.Strings = (
      'select ufssigla from ufs where')
    Left = 500
    Top = 288
  end
  object Dufs: TUniDataSource [43]
    DataSet = ufs
    Left = 436
    Top = 292
  end
  object Dedr: TUniDataSource [44]
    DataSet = edr
    OnDataChange = DedrDataChange
    Left = 1048
    Top = 120
  end
  object ACBrValidador: TACBrValidador [45]
    IgnorarChar = './-'
    Left = 976
    Top = 65528
  end
  object Ddtm: TUniDataSource [46]
    DataSet = dtm
    Left = 808
    Top = 536
  end
  object dtm: TUniQuery [47]
    SQL.Strings = (
      'SELECT dtm.dtmchave'
      '     , dtm.dtmplaca'
      '     , dtm.dtmvolumes'
  ...
  object qTotaisItens: TUniQuery
    SQL.Strings = (
      ...
      '  SUM(itm.itmdesconto) AS desconto,'
        ...
        '  SUM(itm.itmtotal) AS totalItens, -- +SUM(itm.itmdesconto) AS t' +
        'otalItens,'
      ...
      '  SUM(itm.itmipi) AS ipi,'
        ...
        '  SUM(itm.itmtotal  + itm.itmfrete + itm.itmoutras + itm.itmsegu' +
        'ro + itm.itmicms + itm.itmipi) AS totalGeral'
      'FROM itm'
      'WHERE meschave = :meschave'
