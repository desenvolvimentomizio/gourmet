...
uses
  ...
  Datasnap.DSHTTP, inifiles, forms;
...
uses uSMethods, uSContainer, Web.WebReq;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := uSMethods.TServerMethods1.ClassName
...
begin
  ...
  Begin
    ...
    vlServidor := ReadString('posi', 'servidorrest', '127.0.0.1');

    Result := (Request.RemoteAddr = vlServidor) or (Request.RemoteAddr = '0:0:0:0:0:0:0:1') or (Request.RemoteAddr = '::1');
  End;
end;
