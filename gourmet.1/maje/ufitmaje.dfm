inherited fitmaje: Tfitmaje
  ActiveControl = procodigo
  Caption = 'Item de Ajuste'
  ClientHeight = 540
  ExplicitHeight = 579
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited paginas: TPageControl
    ...
    inherited Principal: TTabSheet
      ...
      object Label4: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Saldo Anterior ao Ajuste'
      end
      ...
      object itmquanticontada: TDBEdit
        Left = 136
        Top = 111
        Width = 73
        Height = 21
        CustomHint = BalloonHint
        DataField = 'itmquanticontada'
        DataSource = DSRegistro
        TabOrder = 2
        OnExit = itmquanticontadaExit
      end
  ...
  object pro: TUniQuery
    SQL.Strings = (
      'select procodigo, pronome,prosaldodisp from pro')
    Left = 444
    Top = 68
