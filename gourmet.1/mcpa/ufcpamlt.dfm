inherited fcpamlt: Tfcpamlt
  ...
  inherited registro: TUniQuery
    ...
    Top = 12
    inherited registroflaidentificacao: TStringField
      Visible = False
    end
  ...
  object mcgaju: TUniQuery
    ...
    object mcgajumcgcompetencia: TStringField
      FieldName = 'mcgcompetencia'
      Size = 10
    end
  end
  object rfmtit: TUniQuery
    SQL.Strings = (
  ...
  object mcgalt: TUniQuery
    Left = 868
    Top = 377
  end
  object mcgver: TUniQuery
    Left = 860
    Top = 441
  end
