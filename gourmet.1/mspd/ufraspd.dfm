inherited fraspd: Tfraspd
  ...
  inherited uqtabela: TUniQuery
    SQL.Strings = (
        ...
        ' spddatabalanco,  pcccodigo, spdativo, if(spdativo='#39'1'#39','#39'A'#39','#39' '#39') ' +
        'as ativo, spdregistro, spdenvio, spdpasta  from spd')
    Left = 312
    Top = 292
    ...
    object uqtabelaspdpasta: TStringField
      DisplayLabel = 'Caminho do arquivo do SPED'
      FieldName = 'spdpasta'
      Size = 250
    end
  end
  ...
  object mizio_gab: TUniQuery
    ...
    object mizio_gabmizio_gabversao: TStringField
      FieldName = 'mizio_gabversao'
      Size = 50
    end
    object mizio_gabmizio_gabenviosped: TDateTimeField
      FieldName = 'mizio_gabenviosped'
      Required = True
    end
  end
  ...
  object IdIOHandlerStream1: TIdIOHandlerStream
    Host = 'servpegftp001s.miziosistemas.com.br'
  ...
  object IdFTP1: TIdFTP
    ...
    Host = 'www.miziosistemas.com.br'
    Passive = True
    ConnectTimeout = 0
    Password = 'mizio973*'
    Username = 'arquivos@miziosistemas.com.br'
