...
Begin
  try
    ...
    With arquini Do
    Begin
      vlNomeBanco := ReadString('posi', 'nomebanco', 'gourmet');
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalnovo01+' where puncodigo='+vppromoproduto01; ;
        promochopp.ExecSQL;
      end
      else
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalorig01+' where puncodigo='+vppromoproduto01; ;
        promochopp.ExecSQL;
      end;
    end;
    ...
    begin
      ...
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalnovo02+' where puncodigo='+vppromoproduto02; ;
        promochopp.ExecSQL;
      end
      else
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalorig02+' where puncodigo='+vppromoproduto02; ;
        promochopp.ExecSQL;
      end;
    end;
    ...
    begin
      ...
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalnovo03+' where puncodigo='+vppromoproduto03; ;
        promochopp.ExecSQL;
      end
      else
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalorig03+' where puncodigo='+vppromoproduto03; ;
        promochopp.ExecSQL;
      end;
    end;
    ...
    begin
      ...
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalnovo04+' where puncodigo='+vppromoproduto04; ;
        promochopp.ExecSQL;
      end
      else
      begin
        promochopp.Close;
        promochopp.sql.text:='update pun set  punprecoav='+vppromovalorig04+' where puncodigo='+vppromoproduto04; ;
        promochopp.ExecSQL;
      end;
    end;
