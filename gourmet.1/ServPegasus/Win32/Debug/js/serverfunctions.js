...
function TServerMethodsmizio(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TServerMethodsmizio",connectionInfo);
...
var JSProxyClassList = {
  ...
  "TServerMethodsmizio": ["EchoString","ReverseString"]
};
