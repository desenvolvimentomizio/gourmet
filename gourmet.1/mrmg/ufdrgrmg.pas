...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Vcl.ActnList, System.Actions, Vcl.ImgList,ufuncoes,
  PngImageList, System.ImageList;

type
  Tfdrgrmg = class(Tfrmbase)
...
procedure Tfdrgrmg.ActAlterarExecute(Sender: TObject);
begin
  inherited;
...
procedure Tfdrgrmg.ActExcluirExecute(Sender: TObject);
begin
  inherited;
...
procedure Tfdrgrmg.ActIncluirExecute(Sender: TObject);
begin
  inherited;
  registro.Append;
  pcgcodigo.SetFocus;
...
procedure Tfdrgrmg.bconfirmaClick(Sender: TObject);
begin
...
procedure Tfdrgrmg.DBGListaDrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
var
  fixRect: TRect;
begin
...
procedure Tfdrgrmg.FormShow(Sender: TObject);
begin
  IdModulo := vPlIdMd;
...
procedure Tfdrgrmg.pcgcodigoExit(Sender: TObject);
var
  vestcta: string;
  vestccu: string;
begin
...
procedure Tfdrgrmg.registroAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure Tfdrgrmg.spdbpcgdebitoClick(Sender: TObject);
begin
  inherited;
  vchavepesquisa := '';
