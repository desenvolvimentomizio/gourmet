...
function TSMServerGourmet(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TSMServerGourmet",connectionInfo);
  ...
  /*
   * @param vClbUsuario [in] - Type on server: string
   * @param vClbSenha [in] - Type on server: string
   * @return result - Type on server: TFDJSONDataSets
   */
  this.RetornaRegistros = function(vClbUsuario, vClbSenha) {
    var returnObject = this.executor.executeMethod('RetornaRegistros', "GET", [vClbUsuario, vClbSenha], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.vClbUsuario = vClbUsuario;
        resultObject.vClbSenha = vClbSenha;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.RetornaRegistros_URL = function(vClbUsuario, vClbSenha) {
    return this.executor.getMethodURL("RetornaRegistros", "GET", [vClbUsuario, vClbSenha], arguments[2])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.QuantidadeMesas = function() {
    var returnObject = this.executor.executeMethod('QuantidadeMesas', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.QuantidadeMesas_URL = function() {
    return this.executor.getMethodURL("QuantidadeMesas", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.DadosTgr = function() {
    var returnObject = this.executor.executeMethod('DadosTgr', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DadosTgr_URL = function() {
    return this.executor.getMethodURL("DadosTgr", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.DadosCgr = function() {
    var returnObject = this.executor.executeMethod('DadosCgr', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DadosCgr_URL = function() {
    return this.executor.getMethodURL("DadosCgr", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.DadosGrp = function() {
    var returnObject = this.executor.executeMethod('DadosGrp', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DadosGrp_URL = function() {
    return this.executor.getMethodURL("DadosGrp", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.DadosSfn = function() {
    var returnObject = this.executor.executeMethod('DadosSfn', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DadosSfn_URL = function() {
    return this.executor.getMethodURL("DadosSfn", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.DadosPro = function() {
    var returnObject = this.executor.executeMethod('DadosPro', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.DadosPro_URL = function() {
    return this.executor.getMethodURL("DadosPro", "GET", [], arguments[0])[0];
  };

  /*
   * @param vNumMesa [in] - Type on server: string
   * @return result - Type on server: TFDJSONDataSets
   */
  this.ConsultaUniaoMesa = function(vNumMesa) {
    var returnObject = this.executor.executeMethod('ConsultaUniaoMesa', "GET", [vNumMesa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.vNumMesa = vNumMesa;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.ConsultaUniaoMesa_URL = function(vNumMesa) {
    return this.executor.getMethodURL("ConsultaUniaoMesa", "GET", [vNumMesa], arguments[1])[0];
  };
   ...
   * @return result - Type on server: TFDJSONDataSets
   */
  this.ConsultaMesa = function(vNumMesa) {
    var returnObject = this.executor.executeMethod('ConsultaMesa', "GET", [vNumMesa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.ConsultaMesa_URL = function(vNumMesa) {
    return this.executor.getMethodURL("ConsultaMesa", "GET", [vNumMesa], arguments[1])[0];
  };
   ...
   * @return result - Type on server: TFDJSONDataSets
   */
  this.AbreMesa = function(vClbUsuario, vNumMesa) {
    var returnObject = this.executor.executeMethod('AbreMesa', "GET", [vClbUsuario, vNumMesa], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.AbreMesa_URL = function(vClbUsuario, vNumMesa) {
    return this.executor.getMethodURL("AbreMesa", "GET", [vClbUsuario, vNumMesa], arguments[2])[0];
  };

  /*
   * @param vOrcChave [in] - Type on server: Integer
   * @return result - Type on server: TFDJSONDataSets
   */
  this.CarregaIto = function(vOrcChave) {
    var returnObject = this.executor.executeMethod('CarregaIto', "GET", [vOrcChave], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.vOrcChave = vOrcChave;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.CarregaIto_URL = function(vOrcChave) {
    return this.executor.getMethodURL("CarregaIto", "GET", [vOrcChave], arguments[1])[0];
  };

  /*
   * @return result - Type on server: TFDJSONDataSets
   */
  this.VerificaEstadoCozinha = function() {
    var returnObject = this.executor.executeMethod('VerificaEstadoCozinha', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.VerificaEstadoCozinha_URL = function() {
    return this.executor.getMethodURL("VerificaEstadoCozinha", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TSMServerGourmet": ["EchoString","ReverseString","RetornaRegistros","QuantidadeMesas","DadosTgr","DadosCgr","DadosGrp","DadosSfn","DadosPro","ConsultaUniaoMesa","ConsultaMesa","AbreMesa","CarregaIto","VerificaEstadoCozinha"]
};
