inherited fcfgmgou: Tfcfgmgou
  ActiveControl = cfgmgoupedideliveryaux
  ...
  inherited paginas: TPageControl
    ...
    inherited Principal: TTabSheet
      ...
      object cfgmgouproatendimentoparcial: TDBEdit
        ...
        Height = 21
        CustomHint = BalloonHint
        DataField = 'cfgmgouproatendimentoparcial'
        DataSource = DSRegistro
        TabOrder = 7
      end
      ...
      object cfgmgoupadraovenda: TDBRadioGroup
        Left = 660
        Top = 192
        Width = 185
        Height = 97
        CustomHint = BalloonHint
        Caption = 'Padr'#227'o de venda'
        DataField = 'cfgmgoupadraovenda'
        DataSource = DSRegistro
        Items.Strings = (
          'Para VIAGEM'
          'Consumir no LOCAL')
    ...
    object Delivery: TTabSheet
      ...
      object Label22: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Conta totalizadora Delivery'
      ...
      object Label33: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Controla Entregadores'
        FocusControl = cfgmgoucontrolaentrega
      end
      object Label34: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Retornar todos ao sair'
        FocusControl = cfgmgouretornartodos
      end
      ...
      object cfgmgoucontrolaentrega: TDBEdit
        Left = 144
        Top = 138
        Width = 41
        Height = 21
        CustomHint = BalloonHint
        DataField = 'cfgmgoucontrolaentrega'
        DataSource = DSRegistro
        TabOrder = 5
      end
      object cfgmgouretornartodos: TDBEdit
        Left = 144
        Top = 165
        Width = 41
        Height = 21
        CustomHint = BalloonHint
        DataField = 'cfgmgouretornartodos'
        DataSource = DSRegistro
        TabOrder = 6
      end
    end
    object Integracoes: TTabSheet
      CustomHint = BalloonHint
      ...
      object Label35: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Token  Integra'#231#227'o NUC'
        FocusControl = cfgmgoutokennuc
      end
      object Label36: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Email acesso loja AIQFOME'
        FocusControl = cfgmgousenhalojaaiq
      end
      object Label37: TLabel
        ...
        Height = 13
        CustomHint = BalloonHint
        Caption = 'Senha acesso loja AIQFOME'
        FocusControl = cfgmgouemaillojaaiq
      end
      object cfgmgoutokennuc: TDBEdit
        Tag = 444
        Left = 168
        Top = 3
        Width = 521
        Height = 21
        CustomHint = BalloonHint
        DataField = 'cfgmgoutokennuc'
        DataSource = DSRegistro
        TabOrder = 0
      end
      object cfgmgousenhalojaaiq: TDBEdit
        Tag = 444
        Left = 168
        Top = 30
        Width = 353
        Height = 21
        CustomHint = BalloonHint
        DataField = 'cfgmgousenhalojaaiq'
        DataSource = DSRegistro
        TabOrder = 1
      end
      object cfgmgouemaillojaaiq: TDBEdit
        Tag = 444
        Left = 168
        Top = 57
        Width = 185
  ...
  inherited registro: TUniQuery
    SQL.Strings = (
      ...
      '  , cfgmgou.cfgmgouretornartodos'
      '  , cfgmgou.cfgmgoutokennuc'
      ''
      ''
      ''
      '  ,cfgmgoumensapedido0'
    ...
    object registrocfgmgoucontrolaentrega: TIntegerField
      DisplayLabel = 'Controla Entregadores'
      FieldName = 'cfgmgoucontrolaentrega'
      Required = True
    end
    object registrosencfgmgoucontrolaentrega: TStringField
      FieldKind = fkLookup
      FieldName = 'sencfgmgoucontrolaentrega'
      LookupDataSet = sen
      LookupKeyFields = 'sencodigo'
      LookupResultField = 'senidentificacao'
      KeyFields = 'cfgmgoucontrolaentrega'
      Size = 5
      Lookup = True
    end
    object registrocfgmgouretornartodos: TIntegerField
      FieldName = 'cfgmgouretornartodos'
      Required = True
    end
    object registrosencfgmgouretornartodos: TStringField
      FieldKind = fkLookup
      FieldName = 'sencfgmgouretornartodos'
      LookupDataSet = sen
      LookupKeyFields = 'sencodigo'
      LookupResultField = 'senidentificacao'
      KeyFields = 'cfgmgouretornartodos'
      Size = 5
      Lookup = True
    end
    object registrocfgmgoutokennuc: TStringField
      Tag = 444
      FieldName = 'cfgmgoutokennuc'
      Size = 200
    end
    object registrocfgmgousenhalojaaiq: TStringField
      DisplayLabel = 'Email acesso loja AIQFOME'
      FieldName = 'cfgmgousenhalojaaiq'
      Size = 250
    end
    object registrocfgmgouemaillojaaiq: TStringField
      DisplayLabel = 'Senha acesso loja AIQFOME'
      FieldName = 'cfgmgouemaillojaaiq'
      Size = 250
    end
    object registrocfgmgoupedideliveryinicial: TIntegerField
      FieldName = 'cfgmgoupedideliveryinicial'
    end
    object registrocfgmgoupadraovenda: TIntegerField
      FieldName = 'cfgmgoupadraovenda'
    end
  end
