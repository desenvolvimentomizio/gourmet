...
begin
  try
    ...
    begin
      fcgt.us001333.SQL.SaveToFile(fcgt.vPasta+'\001333.sql');
    end;

    if not fileexists(fcgt.vPasta+'\001334.sql') then
    begin
      fcgt.us001334.SQL.SaveToFile(fcgt.vPasta+'\001334.sql');
    end;

    if not fileexists(fcgt.vPasta+'\001335.sql') then
    begin
      fcgt.us001335.SQL.SaveToFile(fcgt.vPasta+'\001335.sql');
    end;

    if not fileexists(fcgt.vPasta+'\001336.sql') then
    begin
      fcgt.us001336.SQL.SaveToFile(fcgt.vPasta+'\001336.sql');
    end;

    if not fileexists(fcgt.vPasta+'\001337.sql') then
    begin
      fcgt.us001337.SQL.SaveToFile(fcgt.vPasta+'\001337.sql');
    end;
