inherited fravnd: Tfravnd
  ...
  inherited acoes: TActionList
    ...
    inherited ActAtualizar: TAction [3]
      Category = 'Sa'#237'das'
    end
    object ActFaturar: TAction [4]
      Category = 'Sa'#237'das'
      Caption = 'Faturamento'
    ...
    inherited ActPesquisar: TAction [6]
      Category = 'Sa'#237'das'
    end
    object ActAjustarEstagio: TAction [7]
      Category = 'Utilit'#225'rios'
      Caption = 'Ajustar Est'#225'gio'
      OnExecute = ActAjustarEstagioExecute
    end
    inherited ActRelatorios: TAction [8]
      Category = 'Utilit'#225'rios'
    end
    inherited ActVerFiltros: TAction [9]
      Category = 'Utilit'#225'rios'
    end
    inherited ActFiltrar: TAction [10]
      Category = 'Utilit'#225'rios'
    end
    inherited ActConfig: TAction [11]
      Category = 'Utilit'#225'rios'
    end
    inherited ActConfiguracoes: TAction [12]
      Category = 'Utilit'#225'rios'
    end
    object ActGeraCupomFiscal: TAction [13]
      Category = 'Utilit'#225'rios'
      Caption = 'Gera Cupom Fiscal'
      Enabled = False
      OnExecute = ActGeraCupomFiscalExecute
    end
    object ActAjustaOperacao: TAction [14]
      Category = 'Utilit'#225'rios'
      Caption = 'Ajusta Opera'#231#227'o'
      Visible = False
      OnExecute = ActAjustaOperacaoExecute
    end
    inherited ActExcluir: TAction [15]
      Category = 'Utilit'#225'rios'
      Visible = False
    end
    object ActAlterarCliente: TAction [16]
      Category = 'Utilit'#225'rios'
      Caption = 'Alterar Cliente'
      OnExecute = ActAlterarClienteExecute
    end
    object ActFinalizar: TAction [17]
      Category = 'Utilit'#225'rios'
      Caption = 'Finalizar'
  ...
  inherited MenuManutencao: TPopupMenu
    ...
    object Utilitarios: TMenuItem
      ...
      object mAjustaVendaRefeicao: TMenuItem
        Caption = 'Ajusta Venda Refei'#231#227'o'
        OnClick = mAjustaVendaRefeicaoClick
      end
    end
  end
  inherited uqtabela: TUniQuery
    SQL.Strings = (
      ...
      '     , mes.mesoutras'
      '     , LPAD(mes.mesnumeropedido, 4, '#39'0'#39')  mesnumeropedido'
    ...
    object uqtabelamesoutras: TCurrencyField
      DisplayLabel = 'Adicionais/Outros'
      FieldName = 'mesoutras'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
  ...
  inherited cfgmgou: TUniQuery
    SQL.Strings = (
        ...
        'select cfgmgouhoravirada,cfgmgouctadelivery from cfgmgou where c' +
        'fgcodigo=:flacodigo')
    Left = 1032
    Top = 221
    object cfgmgoucfgmgouctadelivery: TIntegerField
  ...
  object itm: TUniQuery
    SQL.Strings = (
      ...
      '     , itm.itmoutras'
      '     , itm.itmtotal'
      '     , (itm.itmtotal - itm.itmdesconto+itmoutras) AS itmtotalliq'
      '     , itm.cfocfop'
      '     , itm.itmaliqipi'
      '     , itm.toecodigo'
      '     , pro.proncm'
  ...
  object uqItmTotais: TUniQuery
    SQL.Strings = (
      ...
      '     , SUM(itm.itmoutras)                  AS itmoutras'
      '     , SUM(itm.itmtotal - itm.itmdesconto) AS itmtotalliq'
      '     , SUM(itm.itmfrete)                   AS itmfrete'
      '  FROM      itm'
    ...
    object uqItmTotaisitmoutras: TCurrencyField
      FieldName = 'itmoutras'
    end
    object uqItmTotaisitmfrete: TCurrencyField
      FieldName = 'itmfrete'
    end
  end
  ...
  object uqDtlTotais: TUniQuery
    SQL.Strings = (
      ...
      '  '
        ...
        'WHERE (mes.mesrefeicao=0 and rfi.tfdcodigo IN (2,32) and  mes.td' +
        'fcodigo<>'#39'RF'#39' AND mes.sdecodigo<>'#39'02'#39
      '  AND '
      '  '
  ...
  object uqDtlConvenios: TUniQuery
    SQL.Strings = (
      ...
      'AND (rfi.tfdcodigo IN (32)'
      'AND mes.flacodigo = :flacodigo'
      'AND mes.mesrefeicao = 0'
      'AND mes.sdecodigo <> '#39'02'#39
      'AND rfi.tficodigo in (9,10))'
      ''
      '-- Filtros  ')
    Left = 1162
    Top = 423
  ...
  object orcssai: TUniQuery
    SQL.Strings = (
      ...
      '  orc.orcchave,'
      '  orc.orcdataabert,'
      '  -- imm.immhoraimpresso orchoraabert,'
      '  orchoraabert,'
      '  orc.orcdataencerr,'
      '  orc.orchoraencerr,'
      '  orc.etdcodigo,'
      ...
      ''
        ...
        ' if(orc.stocodigo=88,'#39'00:00'#39',  DATE_FORMAT(imm.immhoraentrega, '#39 +
        '%H:%i'#39')) AS pdghoraentrega,'
      ''
      ''
      ''
      '  LPAD( CONVERT((SELECT'
      ...
      ''
        ...
        '  if(orc.stocodigo=88,'#39'00:00'#39',  DATE_FORMAT(orc.orcretorno ,'#39'%H:' +
        '%i'#39')) orcretorno,'
      
        '--   if(orc.stocodigo=88,'#39'00:00'#39', TIME_FORMAT( TIMEDIFF(  imm.im' +
        'mhoraentrega,  CONCAT( DATE_FORMAT(orc.orcdataabert, '#39'%Y-%m-%d'#39')' +
        ','#39' '#39', orc.orchoraabert) ), '#39'%H:%i'#39') ) AS tempoemproducao,'
      
        '--   if(orc.stocodigo=88,'#39'00:00'#39', TIME_FORMAT( TIMEDIFF(imm.immh' +
        'oraentrega, imm.immhoraimpresso), '#39'%H:%i'#39') ) AS tempoemproducao,'
      
        'IF( (select cfgmgoutempoatuproducao from cfgmgou)=0,0,     if(or' +
        'c.stocodigo=88,'#39'00:00'#39', TIME_FORMAT( TIMEDIFF(imm.immhoraentrega' +
        ', imm.immhoraimpresso), '#39'%H:%i'#39') )) AS tempoemproducao,'
      
        '   if(orc.stocodigo=88,'#39'00:00'#39', TIME_FORMAT( TIMEDIFF( orc.orcre' +
        'torno,imm.immhoraentrega ), '#39'%H:%i'#39'))  AS tempoementrega,'
      '   orc.moccodigo,'
      
        '  if(orc.stocodigo=88,'#39'C A N C E L A D O'#39',  pdsidentificacao) pd' +
        'sidentificacao,'
      '   imm.clbcodigoent,'
      
        '   IFNULL((SELECT DATE_FORMAT(c1.ccefechamento, '#39'%d/%m/%Y %H:%i'#39 +
        ') FROM cce c1 WHERE c1.clbcodigo=imm.clbcodigoent  and  c1.clbco' +
        'digo=c.clbcodigo ORDER BY c1.ccechave DESC LIMIT 1),'#39'CAIXA ABERT' +
        'O'#39') situacaocaixa, '
      '  pds.pdscodigo,'
      '  orc.stocodigo'
      ''
    ...
    object orcssaiclbidentificacao: TStringField
      DisplayLabel = 'Atendende'
      FieldName = 'clbidentificacao'
      Size = 30
    end
    ...
    object orcssaitempoemproducao: TStringField
  ...
  object TotaisResumo: TVirtualTable
    FieldDefs = <
      item
    ...
    Top = 625
    Data = {
      }
    object TotaisResumomdaidentificacao: TStringField
      DisplayLabel = 'Modalidade'
      FieldName = 'mdaidentificacao'
      Size = 35
    end
    object TotaisResumodtlvalor: TFloatField
      DisplayLabel = 'Valor R$'
      FieldName = 'dtlvalor'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object TotaisResumomdacodigo: TIntegerField
      FieldName = 'mdacodigo'
    end
    object TotaisResumoltechave: TIntegerField
      DisplayLabel = 'Lote'
      FieldName = 'ltechave'
    end
    object TotaisResumordcnrauto: TStringField
      DisplayLabel = 'Nr. Autoriza'#231#227'o'
      FieldName = 'rdcnrauto'
      Size = 200
    end
    object TotaisResumodtlchave: TIntegerField
      DisplayLabel = 'Detalhe Lte'
      FieldName = 'dtlchave'
    end
  end
  object dtlResumo: TUniQuery
    SQL.Strings = (
      ''
      'SELECT DISTINCT'
      ''
