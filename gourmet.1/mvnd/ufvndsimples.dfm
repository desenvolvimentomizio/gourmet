inherited fvndsimples: Tfvndsimples
  ...
  object gravaitmref: TUniQuery
    SQL.Strings = (
      ...
      'itmcontendo'
      ' from itm where meschave=:meschave')
    AfterInsert = gravaitmrefAfterInsert
    Left = 1024
    Top = 376
    ParamData = <
      item
    ...
    object gravaitmrefitmchave: TIntegerField
      AutoGenerateValue = arAutoInc
      DisplayLabel = 'Nr. Chave'
      FieldName = 'itmchave'
    end
    object gravaitmrefmeschave: TIntegerField
      DisplayLabel = 'Nr. Registro'
      FieldName = 'meschave'
      Required = True
    end
    object gravaitmrefitmitem: TIntegerField
      DisplayLabel = 'Item'
      FieldName = 'itmitem'
      Required = True
    end
    object gravaitmrefprocodigo: TIntegerField
      DisplayLabel = 'C'#243'digo do Produto'
      FieldName = 'procodigo'
      Required = True
    end
    object gravaitmrefunicodigo: TIntegerField
      DisplayLabel = 'Unidade de Compra'
      FieldName = 'unicodigo'
      Required = True
    end
    object gravaitmrefcstcodigo: TStringField
      DisplayLabel = 'C'#243'digo CST'
      FieldName = 'cstcodigo'
      Required = True
      Size = 3
    end
    object gravaitmrefitmdesccomple: TStringField
      FieldName = 'itmdesccomple'
      Size = 250
    end
    object gravaitmrefitmquantidade: TFloatField
      DisplayLabel = 'Quantidade'
      FieldName = 'itmquantidade'
      Required = True
      DisplayFormat = '#,###0.000'
    ...
    object gravaitmrefitmvalor: TFloatField
      DisplayLabel = 'Valor do Item R$'
      FieldName = 'itmvalor'
      Required = True
      DisplayFormat = '#,##0.00'
    ...
    object gravaitmrefitmdesconto: TFloatField
      DisplayLabel = 'Desconto R$'
      FieldName = 'itmdesconto'
      Required = True
      DisplayFormat = '#,##0.00'
    ...
    object gravaitmrefitmmovifisico: TStringField
      FieldName = 'itmmovifisico'
      Required = True
      FixedChar = True
      Size = 1
    end
    object gravaitmreftoecodigo: TIntegerField
      DisplayLabel = 'Tipo de Opera'#231#227'o'
      FieldName = 'toecodigo'
      Required = True
    end
    object gravaitmrefcfocfop: TStringField
      FieldName = 'cfocfop'
      Required = True
      Size = 5
    end
    object gravaitmrefitmbicm: TFloatField
      FieldName = 'itmbicm'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmreficmcodigo: TStringField
      FieldName = 'icmcodigo'
      Size = 3
    end
    object gravaitmrefitmaliqicm: TStringField
      FieldName = 'itmaliqicm'
      Required = True
      Size = 6
    end
    object gravaitmrefitmicm: TFloatField
      FieldName = 'itmicm'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmrefitmbicms: TFloatField
      FieldName = 'itmbicms'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmrefitmaliqicms: TFloatField
      FieldName = 'itmaliqicms'
      Required = True
      DisplayFormat = '#,###0.000'
      EditFormat = '#,###0.000'
    end
    object gravaitmrefitmicms: TFloatField
      DisplayLabel = 'Percentual ICMS Subst R$'
      FieldName = 'itmicms'
      Required = True
      DisplayFormat = '#,##0.00'
    ...
    object gravaitmrefitmapuipi: TStringField
      FieldName = 'itmapuipi'
      Required = True
      FixedChar = True
      Size = 1
    end
    object gravaitmrefcsicodigo: TStringField
      FieldName = 'csicodigo'
      Required = True
      Size = 2
    end
    object gravaitmrefceicodigo: TStringField
      FieldName = 'ceicodigo'
      Size = 5
    end
    object gravaitmrefitmbipi: TFloatField
      FieldName = 'itmbipi'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmrefpuncodigo: TIntegerField
      FieldName = 'puncodigo'
      Required = True
    end
    object gravaitmrefitmaliqipi: TFloatField
      FieldName = 'itmaliqipi'
      Required = True
      DisplayFormat = '#,###0.000'
      EditFormat = '#,###0.000'
    end
    object gravaitmrefitmipi: TFloatField
      DisplayLabel = 'Percentual de IPI'
      FieldName = 'itmipi'
      Required = True
      DisplayFormat = '#,###0.000'
    ...
    object gravaitmrefcspcodigo: TStringField
      FieldName = 'cspcodigo'
      Required = True
      Size = 3
    end
    object gravaitmrefitmpis: TFloatField
      FieldName = 'itmpis'
    end
    object gravaitmrefitmbpis: TFloatField
      FieldName = 'itmbpis'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmrefitmaliqpis: TFloatField
      FieldName = 'itmaliqpis'
      Required = True
    end
    object gravaitmrefitmquantpis: TFloatField
      FieldName = 'itmquantpis'
      Required = True
    end
    object gravaitmrefitmaliqpisvalor: TFloatField
      FieldName = 'itmaliqpisvalor'
      Required = True
    end
    object gravaitmrefcsfcodigo: TStringField
      FieldName = 'csfcodigo'
      Required = True
      Size = 3
    end
    object gravaitmrefitmbcofins: TFloatField
      FieldName = 'itmbcofins'
      Required = True
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object gravaitmrefitmaliqcofins: TFloatField
      FieldName = 'itmaliqcofins'
      Required = True
    end
    object gravaitmrefitmquantcofins: TFloatField
      FieldName = 'itmquantcofins'
      Required = True
    end
    object gravaitmrefitmaliqcofinsvalor: TFloatField
      FieldName = 'itmaliqcofinsvalor'
      Required = True
    end
    object gravaitmrefitmcofins: TFloatField
      FieldName = 'itmcofins'
      Required = True
    end
    object gravaitmrefpcccodigo: TStringField
      FieldName = 'pcccodigo'
      Required = True
      Size = 60
    end
    object gravaitmrefitmtotal: TFloatField
      DisplayLabel = 'Valor do Item R$'
      FieldName = 'itmtotal'
      Required = True
      DisplayFormat = '#,##0.00'
    ...
    object gravaitmrefunicodigobase: TIntegerField
      FieldName = 'unicodigobase'
    end
    object gravaitmrefcfocfopdestinacao: TStringField
      FieldName = 'cfocfopdestinacao'
      Size = 5
    end
    object gravaitmrefitmcontendo: TFloatField
      FieldName = 'itmcontendo'
    end
    object gravaitmrefitmoutras: TFloatField
      FieldName = 'itmoutras'
    end
  end
  ...
  object itmref: TFDMemTable
    ...
    object itmrefitmoutras: TFloatField
      FieldName = 'itmoutras'
    end
  end
end
