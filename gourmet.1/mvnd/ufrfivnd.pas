...
procedure Tfrfivnd.bconfirmaClick(Sender: TObject);
var
  i: Integer;
  Confirma: Integer;
  vlGebChave: Integer;
...
procedure Tfrfivnd.ModuloBoleto(vRotina: TRotinasBoletos; vGebCodigo, vBolChave: Integer);
type
...
procedure Tfrfivnd.FormShow(Sender: TObject);
begin
  mes.Close;
...
procedure Tfrfivnd.registroAfterInsert(DataSet: TDataSet);
begin
  inherited;
  ...
  registrotithistorico.AsString := 'Vnd.Chave: ' + vChaveMestre;

end;

procedure Tfrfivnd.tficodigoExit(Sender: TObject);
begin
  inherited;
...
procedure Tfrfivnd.titmoradiaExit(Sender: TObject);
begin
  inherited;
  Self.ValidaSaida(Sender);
  (* Identifica se usuário está abandonando a tela *)
...
procedure Tfrfivnd.titpercmesmoraExit(Sender: TObject);
begin
  inherited;
...
procedure Tfrfivnd.titpercmultaExit(Sender: TObject);
begin
  inherited;
...
procedure Tfrfivnd.titvalomultaExit(Sender: TObject);
begin
  inherited;
...
procedure Tfrfivnd.titvalorparcelaExit(Sender: TObject);
begin
  inherited;
...
function Tfrfivnd.GerarBoleto(vTitCodigo: Integer): Integer;
type
...
procedure Tfrfivnd.titvctoinicialExit(Sender: TObject);
begin
  inherited;
