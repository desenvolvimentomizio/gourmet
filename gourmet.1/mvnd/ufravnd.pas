...
begin
  ...
  try
    ...
    uniResumoDtl.SQL.Add('INNER JOIN ori ON mes.oricodigo = ori.oricodigo ');
...
//    uniResumoDtl.SQL.Add('AND lte.tfdcodigo=32 ');
    ...
    begin
      ...
      Pltotalvendas.caption := 'Bruto: ' + FormatFloat('##,###,##0.00', vlTotalBruto);
      ...
      Pltotalliquido.caption := '(=) : ' + FormatFloat('##,###,##0.00',vlTotalLiquido);
