...
begin
  ...
  consulta.Close;
  consulta.SQL.Text:='update pun set imecodigo='+registroimucodigoimendes.AsString  +' where procodigo='+vChaveMestre;
  consulta.ExecSQL;
...
begin
  ...
  try
    ...
    vlJson := '{"cabecalho":{' + '"cnpj":"'+ SoNumeros(cfgetddoc1.asstring) + '",' + '"cnae":"4712100",' + '"crt":3,' + '"regimeEspecial":"",' + '"codFaixa":"98",' +
      '"regimeTrib":"P",' + '"contribuinte":1,' + '"amb":2' + '},' + '"uf":["MT"],' + '"produto":[';
