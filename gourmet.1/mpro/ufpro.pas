...
type
  Tfpro = class(Tfrmbase)
    ...
    registronrtcodigo: TStringField;
    registronrtidentificacao: TStringField;
    cfgcfgapuracaoicm: TIntegerField;
    gbRegraTitbutaria: TPanel;
    Label13: TLabel;
    nrtcodigo: TDBEdit;
...
begin
  ...
  begin
    ...
    begin
      ...
      registrocfocfopfora.AsString := cfocfop.Field.AsString;

      if registrocfocfopfora.AsString = '5.405' then
        registrocfocfopfora.AsString := '5.403';
...
if (cfgcfgapuracaoicm.AsInteger=2) AND (cfgcrtcodigo.AsInteger>=3) then
  begin
    nrt.Close;
    nrt.Open;

    gbRegraTitbutaria.Visible:=true;
    registronrtcodigo.Required:=true;
    nrtcodigo.Color := PEG_COR_VALORREQUERIDO;

  end
  else
  begin
    gbRegraTitbutaria.Visible:=False;
    registronrtcodigo.Required:=False;
    nrtcodigo.Color := clWhite;
  end;
