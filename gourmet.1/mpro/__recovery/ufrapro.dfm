inherited frapro: Tfrapro
      ...
      inherited PnlGrid: TPanel
        ...
        inherited DBGLista: TDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'proenvioimendes'
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'proretornoimendes'
              Visible = True
            end>
        end
  ...
  inherited acoes: TActionList
    ...
    inherited ActAtualizar: TAction [2]
      Category = 'Produtos'
    end
    object ActCurvaABC: TAction [3]
      Category = 'Produtos'
      Caption = 'Curva ABC'
      OnExecute = ActCurvaABCExecute
    end
    object ActHistoricoCusto: TAction [4]
      Category = 'Produtos'
    ...
    object ActVariacoes: TAction [6]
      Category = 'Produtos'
      Caption = 'Varia'#231#245'es'
      Enabled = False
      OnExecute = ActVariacoesExecute
    end
    object ActBuscaBarra: TAction [7]
      Category = 'Produtos'
    ...
    object ActMovimentacao: TAction [8]
      Category = 'Produtos'
      Caption = 'Extrato'
      ImageIndex = 11
      OnExecute = ActMovimentacaoExecute
    end
    inherited ActVerFiltros: TAction [9]
      Category = 'Produtos'
    end
    object ActVerCusto: TAction [10]
      Category = 'Produtos'
      Caption = 'Ver Custo'
      OnExecute = ActVerCustoExecute
    end
    object ActHistoricoMovimento: TAction [11]
      Category = 'Produtos'
      Caption = 'Hist'#243'rico Movimento'
      Enabled = False
      OnExecute = ActHistoricoMovimentoExecute
    end
    object ActHistoricoPreco: TAction [12]
      Category = 'Produtos'
      Caption = 'Hist'#243'rico Custo/Pre'#231'o'
      OnExecute = ActHistoricoPrecoExecute
    end
    inherited ActExcluir: TAction [13]
      Category = 'Produtos'
      Enabled = False
    end
    object ActPrecoDeVenda: TAction [14]
    ...
    object ActPrecoDeCusto: TAction [15]
      Category = 'Altera'#231#245'es'
    ...
    object ActTrocarNCMs: TAction [20]
      Category = 'NCMs'
      Caption = 'Trocar TODOS NCMs'
      OnExecute = ActTrocarNCMsExecute
    end
    object ActAtualizarNCM: TAction [21]
      Category = 'NCMs'
    ...
    object ActAjustarCEST: TAction [22]
      Category = 'CESTs'
      Caption = 'Ajustar CEST'
      OnExecute = ActAjustarCESTExecute
    end
    object ActTrocarCEST: TAction [23]
      Category = 'CESTs'
      Caption = 'Trocar TODOS CESTs'
      OnExecute = ActTrocarCESTExecute
    end
    object ActIMEStatus: TAction [24]
      Category = 'Imendes'
      Caption = 'Situa'#231#227'o do Cadastro'
      OnExecute = ActIMEStatusExecute
    end
    object ActIMESituacao: TAction [25]
      Category = 'Imendes'
      Caption = 'Situa'#231#227'o dos Produtos'
      OnExecute = ActIMESituacaoExecute
    end
    object ActIMEHistorico: TAction [26]
      Category = 'Imendes'
      Caption = 'Hist'#243'ricos de Acesso'
      OnExecute = ActIMEHistoricoExecute
    end
    object ActIMEAtualizarAPI: TAction [27]
      Category = 'Imendes'
      Caption = 'Saneamento'
      OnExecute = ActIMEAtualizarAPIExecute
    end
    object ActIMEAguardando: TAction [28]
      Category = 'Imendes'
      Caption = 'Processar Pendentes'
      OnExecute = ActIMEAguardandoExecute
    end
    object ActIMEBuscaNome: TAction [29]
      Category = 'Imendes'
      Caption = 'Busca por Nome'
      OnExecute = ActIMEBuscaNomeExecute
    end
    object ActIMELaudo: TAction [30]
      Category = 'Imendes'
      Caption = 'Laudo'
      OnExecute = ActIMELaudoExecute
    end
    object ActVerificarDuplicidade: TAction [31]
    ...
    inherited ActFiltrar: TAction [32]
      Category = 'Utilit'#225'rios'
    end
    inherited ActConfiguracoes: TAction [33]
      Category = 'Utilit'#225'rios'
      ImageIndex = 11
    end
    object ActRecalculaSaldo: TAction [34]
      Category = 'Utilit'#225'rios'
      Caption = 'Recalcular Todos'
      ImageIndex = 11
      OnExecute = ActRecalculaSaldoExecute
    end
    object ActEtiquetas: TAction [35]
      Category = 'Utilit'#225'rios'
      Caption = 'Gerar Etiquetas'
      OnExecute = ActEtiquetasExecute
    end
    object ActDesativar: TAction [36]
      Category = 'Situa'#231#227'o'
      Caption = 'Desativar'
      ImageIndex = 10
      OnExecute = ActDesativarExecute
    end
    object ActReativar: TAction [37]
      Category = 'Situa'#231#227'o'
      Caption = 'Reativar'
      ImageIndex = 8
      OnExecute = ActReativarExecute
    end
    object ActMostrarInativos: TAction [38]
      Category = 'Situa'#231#227'o'
      Caption = 'Mostrar Inativos'
    end
    object ActAjustarCusto: TAction [39]
      Category = 'Utilit'#225'rios'
      Caption = 'Ajustar Custo'
      Hint = 'Ajustar pre'#231'o de custo pela ultima compra realizada'
    end
    inherited ActSair: TAction [40]
      Category = 'Utilit'#225'rios'
    end
    inherited ActInstrucoes: TAction [41]
    end
    inherited ActConfig: TAction [42]
      Category = 'Utilit'#225'rios'
    end
    inherited ActRelatorios: TAction [43]
  ...
  inherited uqtabela: TUniQuery
    ...
    object uqtabelaicmaliquotasfora: TStringField
      DisplayLabel = 'ICM Fora'
      FieldName = 'icmaliquotasfora'
      Size = 8
    end
    object uqtabelaproenvioimendes: TDateField
      DisplayLabel = 'Envio Imendes'
      FieldName = 'proenvioimendes'
    end
    object uqtabelaproretornoimendes: TDateField
      DisplayLabel = 'Retorno Imendes'
      FieldName = 'proretornoimendes'
    end
  end
  ...
  object cfg: TUniQuery
    SQL.Strings = (
      ...
      '  INNER join cfgmspd  ON cfgmspd.cfgcodigo = cfgmsai.cfgcodigo'
  ...
  object ans: TUniQuery
    ...
    Left = 496
    Top = 533
    object ansanschave: TIntegerField
      FieldName = 'anschave'
    end
    object ansansanexo: TStringField
      FieldName = 'ansanexo'
    end
    object anstcgncm: TStringField
      FieldName = 'tcgncm'
    end
    object ansansitem: TStringField
      FieldName = 'ansitem'
    end
    object ansansdescricao: TStringField
      FieldName = 'ansdescricao'
      Size = 5000
    end
  end
  object cest: TUniQuery
    SQL.Strings = (
      'SELECT'
      '  tcechave,'
      '  tceitem,'
    ...
    Left = 456
    Top = 533
    object cesttcechave: TIntegerField
      FieldName = 'tcechave'
    end
    object cesttcecest: TStringField
      FieldName = 'tcecest'
    end
    object cesttcedescricao: TStringField
      FieldName = 'tcedescricao'
      Size = 5000
    end
    object cesttcencm: TStringField
      FieldName = 'tcencm'
    end
    object cesttceitem: TStringField
      FieldName = 'tceitem'
      Size = 10
    end
  end
  ...
  object imu: TUniQuery
    ...
    Left = 936
    Top = 179
    object imuimuid: TIntegerField
      AutoGenerateValue = arAutoInc
      FieldName = 'imuid'
    end
    object imuimuean: TStringField
      FieldName = 'imuean'
      Required = True
    end
    object imuimucodigointerno: TStringField
      FieldName = 'imucodigointerno'
      Required = True
      Size = 50
    end
    object imuimucodigoimendes: TStringField
      FieldName = 'imucodigoimendes'
    end
    object imuimustatus: TStringField
      FieldName = 'imustatus'
      Required = True
      Size = 2
    end
    object imuimudescricao: TStringField
      FieldName = 'imudescricao'
      Required = True
      Size = 200
    end
    object imuimuncm: TStringField
      FieldName = 'imuncm'
      Required = True
      Size = 10
    end
    object imuimucest: TStringField
      FieldName = 'imucest'
      Required = True
      Size = 10
    end
    object imuimupercipi: TStringField
      FieldName = 'imupercipi'
      Required = True
      Size = 10
    end
    object imuimucestipi: TStringField
      FieldName = 'imucestipi'
      Required = True
      Size = 10
    end
    object imuimucstpiscofinsent: TStringField
      FieldName = 'imucstpiscofinsent'
      Required = True
      Size = 10
    end
    object imuimucstpiscofinssai: TStringField
      FieldName = 'imucstpiscofinssai'
      Required = True
      Size = 10
    end
    object imuimunatrecisenta: TStringField
      FieldName = 'imunatrecisenta'
      Required = True
      Size = 10
    end
    object imuimulista: TStringField
      FieldName = 'imulista'
    end
    object imuimutipo: TStringField
      FieldName = 'imutipo'
    end
    object imuimupercpis: TStringField
      FieldName = 'imupercpis'
      Required = True
      Size = 10
    end
    object imuimuperccofins: TStringField
      FieldName = 'imuperccofins'
      Required = True
      Size = 10
    end
    object imuimucfopcompra: TStringField
      FieldName = 'imucfopcompra'
      Required = True
      Size = 10
    end
    object imuimucfopvenda: TStringField
      FieldName = 'imucfopvenda'
      Required = True
      Size = 10
    end
    object imuimucst: TStringField
      FieldName = 'imucst'
      Required = True
      Size = 10
    end
    object imuimucsosn: TStringField
      FieldName = 'imucsosn'
    end
    object imuimumodbc: TStringField
      FieldName = 'imumodbc'
      Required = True
      Size = 10
    end
    object imuimupercicms: TStringField
      FieldName = 'imupercicms'
      Required = True
      Size = 10
    end
    object imuimuicmspdv: TStringField
      FieldName = 'imuicmspdv'
      Required = True
      Size = 10
    end
    object imuimusimbpdv: TStringField
      FieldName = 'imusimbpdv'
      Required = True
      Size = 10
    end
    object imuimupercredbcicms: TStringField
      FieldName = 'imupercredbcicms'
      Required = True
      Size = 10
    end
    object imuimupercredbcicmsst: TStringField
      FieldName = 'imupercredbcicmsst'
      Required = True
      Size = 10
    end
    object imuimupercmodbcst: TStringField
      FieldName = 'imupercmodbcst'
      Required = True
      Size = 10
    end
    object imuimupercicmsst: TStringField
      FieldName = 'imupercicmsst'
      Required = True
      Size = 10
    end
    object imuimuiva: TStringField
      FieldName = 'imuiva'
      Required = True
      Size = 10
    end
    object imuimupautast: TStringField
      FieldName = 'imupautast'
      Required = True
      Size = 10
    end
    object imuimupercfcp: TStringField
      FieldName = 'imupercfcp'
      Required = True
      Size = 10
    end
    object imuimuantecipado: TStringField
      FieldName = 'imuantecipado'
      Required = True
      Size = 10
    end
    object imuimudtultcons: TDateField
      FieldName = 'imudtultcons'
    end
    object imuimudtrev: TDateField
      FieldName = 'imudtrev'
    end
    object imuimutipocodigo: TStringField
      FieldName = 'imutipocodigo'
      Size = 10
    end
  end
  ...
  object RESTRmp: TFDMemTable
    ...
    Left = 48
    Top = 537
    object RESTRmpchave: TStringField
      FieldName = 'chave'
      Size = 0
    end
    object RESTRmpcodigo: TIntegerField
      FieldName = 'codigo'
    end
    object RESTRmpitem: TStringField
      FieldName = 'item'
      Size = 10
    end
    object RESTRmpchaveimm: TIntegerField
      FieldName = 'chaveimm'
    end
    object RESTRmppessoas: TIntegerField
      FieldName = 'pessoas'
    end
  end
  object DSRESTRmp: TDataSource
    DataSet = RESTRmp
    Left = 40
    Top = 592
  end
