unit ufuncBuscaProduto;

interface

uses
  System.SysUtils, ACBrValidador, uni, System.Classes, DAScript, UniScript;
  ...
  try
    ...
    begin
      ...
      try
        ...
        Consulta.Close;
        Consulta.SQL.Text := 'SELECT cfgmsai.cfgbalanca FROM cfgmsai';
        Consulta.Open;
    ...
    begin
      ...
      try
        ...
        BuscaPro.SQL.Add('WHERE tpocodigo IN (0, 4, 9) ');
        BuscaPro.SQL.Add('AND pro.procodigo = pun.procodigo ');
        BuscaPro.SQL.Add('AND pun.punbarraposi = ' + CBarra);
        BuscaPro.Open;
