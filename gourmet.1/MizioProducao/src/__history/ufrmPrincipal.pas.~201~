...
type
  ...
  private
    ...
    function registraProducao:Boolean;
    procedure RegistrarProducao;
...
function TFrmPrincipal.registraProducao:Boolean;
var
  i:integer;
  vlPessoas:Integer;
  vlNumero:String;
  ...
  try
    ...
    try
      ...
      begin
        ...
        vpProducao.Add(TJSONObject.Create
                                    .AddPair('chave','' )
...
Procedure TFrmPrincipal.RegistrarProducao;
var
  vlRetorno:Integer;
begin
  ...
  begin
      ...
      if registraProducao then
      begin

        vlRetorno := GravaProducao(FIPServidorREST, vpProducao);
...
begin
  ...
  try
    ...
    else if TbListas.ActiveTab=TISetores then
    begin
    ...
    else if TbListas.ActiveTab=TIColaboradores then
    begin
