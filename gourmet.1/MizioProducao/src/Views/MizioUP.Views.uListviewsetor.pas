...
type
    ...
    public
        ...
        class procedure SelecionarItem(lv: TListView; Item: TListViewItem; img_uncheck, img_check: TBitmap); static;
...
class procedure TListviewSetor.SetupItem(lv: TListView; Item: TListViewItem; img_uncheck, img_check: TBitmap);
begin
    with item do
    begin
        if Checked then
...
class procedure TListviewSetor.SelecionarItem(lv: TListView; Item: TListViewItem; img_uncheck, img_check: TBitmap);
begin
    Item.Checked := NOT Item.Checked;
    SetupItem(lv, item, img_uncheck, img_check);
end;

class function TListviewSetor.SelectedCount(lview: TListView): integer;
var
    x : integer;
begin
    Result := 0;
...
class procedure TListviewSetor.AddItem(lv: TListView; codigo, descricao: string; bmp: TBitmap);
begin
