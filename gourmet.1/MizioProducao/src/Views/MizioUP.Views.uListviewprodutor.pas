...
class procedure TListviewProdutor.AddItem(lv: TListView; acodigo:Integer; aQuantidadeProduzida,aPontuacao, aNomeProdutor:String );
var
  vLargura: Single;
  vItem: TListViewItem;
