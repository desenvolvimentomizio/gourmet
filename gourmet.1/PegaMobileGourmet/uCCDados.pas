...
uses
  System.JSON, Datasnap.DSProxyRest, Datasnap.DSClientRest, Data.DBXCommon, Data.DBXClient, Data.DBXDataSnap, Data.DBXJSON, Datasnap.DSProxy, System.Classes, System.SysUtils,
  Data.DB, Data.SqlExpr, Data.DBXDBReaders, Data.DBXCDSReaders, Data.FireDACJSONReflect, Data.DBXJSONReflect;
...
const
  TSMServerGourmet_EchoString: array [0 .. 1] of TDSRestParameterMetaData = ((Name: 'Value'; Direction: 1; DBXType: 26; TypeName: 'string'), (Name: ''; Direction: 4; DBXType: 26;
    TypeName: 'string'));

  TSMServerGourmet_ReverseString: array [0 .. 1] of TDSRestParameterMetaData = ((Name: 'Value'; Direction: 1; DBXType: 26; TypeName: 'string'), (Name: ''; Direction: 4;
    DBXType: 26; TypeName: 'string'));

  TSMServerGourmet_RetornaRegistros: array [0 .. 2] of TDSRestParameterMetaData = ((Name: 'vClbUsuario'; Direction: 1; DBXType: 26; TypeName: 'string'), (Name: 'vClbSenha';
    Direction: 1; DBXType: 26; TypeName: 'string'), (Name: ''; Direction: 4; DBXType: 37; TypeName: 'TFDJSONDataSets'));

  TSMServerGourmet_RetornaRegistros_Cache: array [0 .. 2] of TDSRestParameterMetaData = ((Name: 'vClbUsuario'; Direction: 1; DBXType: 26; TypeName: 'string'), (Name: 'vClbSenha';
