inherited fracpa: Tfracpa
  ...
  inherited acoes: TActionList
    ...
    object ActPagarEste: TAction [12]
      Category = 'Movimenta'#231#245'es'
      Caption = 'Pagar Este'
      Enabled = False
      Visible = False
      OnExecute = ActPagarEsteExecute
    end
    object ActEstorno: TAction [13]
      Category = 'Movimenta'#231#245'es'
      Caption = 'Estorno'
      OnExecute = ActEstornoExecute
    end
    object ActDetalhe: TAction [14]
      Category = 'Movimenta'#231#245'es'
      Caption = 'Detalhes'
      OnExecute = ActDetalheExecute
    end
    object ActGerarPlanilha: TAction [22]
