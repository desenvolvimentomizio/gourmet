...
type
  Tfrarcc = class(Tfrarcr)
    ...
    procedure DBGListaMceDrawColumnCell(Sender: TObject; const Rect: TRect;
...
procedure Tfrarcc.DBGListaMceDrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  inherited;
...
procedure Tfrarcc.DSTabelaDataChange(Sender: TObject; Field: TField);
begin
  inherited;
