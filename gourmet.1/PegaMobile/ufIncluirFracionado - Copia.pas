...
uses
  ...
  Vcl.Imaging.pngimage, uniImage, unimImage;
...
begin
  ...
  begin
    ...
    begin
      MainModule.UniMainModule.adc.Close;
      MainModule.UniMainModule.adc.Params[0].AsInteger := mainmForm.Usuario.tsicodigo;
      MainModule.UniMainModule.adc.Open;
    end;
...
begin
  ...
  begin
    if MainModule.UniMainModule.fIngredientetipo.AsInteger = 1 then
      ...
      ShowMessage('Só ingredientes adicionáis podem ser exlcuir, não é possível excluir!');
  end
  else
