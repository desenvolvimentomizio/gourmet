...
begin
  ...
  begin
    ...
    vIpServer := vpConfigIni.ReadString('posi', 'servidor', 'Não foi informado o IP SERVIDOR  em "server"' + #13 + 'Verifique arquivo de configuração em :' +
    ...
    try
      ...
      on E: Exception do
      begin
        ShowMessage('Erro - Ao abrir Conexão verifique as configurações no arquivo Gourmeterp.Ini' + #13 + 'Verifica arquivo de configuração em : ' + ExtractFilePath(ParamSTR(0)) + #13
