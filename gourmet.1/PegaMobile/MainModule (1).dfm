object UniMainModule: TUniMainModule
  ...
  object pun: TUniQuery
    ...
    SQL.Strings = (
      ...
      ' WHERE procodigo = :procodigo and pun.tuncodigo in(1,9)'
  ...
  object proc: TUniQuery
    ...
    SQL.Strings = (
      ...
      '   '
      ' ORDER BY sbr.sbrordem, pro.pronome'
      ''
      ''
      '/*'
      'SELECT pro.procodigo'
  ...
  object ito: TUniQuery
    ...
    SQL.Strings = (
      ...
      '     , ito.puncodigo           -- pun codigo '
        ...
        '     , IfNULL(DATE_FORMAT(immhoraimpresso, '#39'%d %H:%i'#39'),'#39#39')   imm' +
        'horaimpresso        -- hora de impressao '
      '  FROM ito'
      '  '
      ' INNER JOIN pro ON ito.procodigo = pro.procodigo'
      ' '
