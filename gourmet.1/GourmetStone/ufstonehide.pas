...
var
  fstonehide: Tfstonehide;

implementation

{$R *.dfm}

function  Tfstonehide.recebimentoDireto(aOrcChave:String;aPedido:String;aMaquinaPOS:String; aValor:Double; aNome:string):string;
var
 lRes  : IResponse;
 lJson : TJson;
...
procedure  Tfstonehide.ProcessaPagamentos(aOrcChave:String;aNumeroPedido:String;aIdPagamento:String);
var
 lRes  : IResponse;
 lJson : TJson;
 valor : String;
...
function Tfstonehide.RegistraCCO(avalor: Double; aCtaCodigo: String;  adoacao: Integer = 0; aTfiCodigo:Integer=0; altechave:Integer=0; aDtlChave:Integer=0): string;
var
  vlCcoChave:Integer;
begin
...
procedure Tfstonehide.GeraNFCe(aOrcChave:String);
var
  vlMesChave: string;
begin
  inherited;
...
function Tfstonehide.ModuloNFCe(vfuncao: string; vTrmCodigo: string; vmeschave: string; vClbCodigo: string): Boolean;
type
...
procedure Tfstonehide.trmstoneBeforeOpen(DataSet: TDataSet);
begin
...
function Tfstonehide.ExecutaCancelamentoStone(aIdPagamento:string; aOrcChave:string):boolean;
var
  lJson: TJson;
  lRes: IResponse;
  vlTentativas:Integer;
