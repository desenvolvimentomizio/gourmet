...
procedure Tfetl.DSRegistroDataChange(Sender: TObject; Field: TField);
begin
  inherited;
  if self.registroetltipo.AsInteger = 1 then
  begin
    letldias.Caption := 'Intervalo';
  end
  else if self.registroetltipo.AsInteger = 2 then
  begin
    letldias.Caption := 'Dia fixo do mês';
  end;
