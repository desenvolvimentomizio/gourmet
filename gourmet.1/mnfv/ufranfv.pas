...
uses
  ...
  Vcl.StdCtrls, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, Vcl.Imaging.jpeg, Vcl.Mask, Vcl.DBCtrls, Vcl.Imaging.pngimage, uframnf, uPegabase, Vcl.ComCtrls,
  ufuncoes, System.ImageList, Vcl.ImgList;

type
  Tfranfv = class(Tframnf)
...
begin
  ...
  pCargaFrame.Filtro := 'ttocodigo=2 and tdfcodigo=' + QuotedStr('55');
  franfv := Tfranfv.Create(pCargaFrame);
end;
...
procedure Tfranfv.RecalculaTotais;
var
  rgi: Integer;
  vtotsai: Double;
  vtotdessai: Double;
...
begin
  ...
  plNFesaiEmitir.Caption := 'Primeira Nota: ' + FormatFloat('0000000', vlPrimeiraNota);
