...
uses
  ...
  madListModules,
  Vcl.SvcMgr,
  uGourmetServerSvc in 'uGourmetServerSvc.pas' {GourmetServerServer: TService},
  ...
  GourmetServer.Controller.AIQ in 'src\Controller\GourmetServer.Controller.AIQ.pas',
...
begin
  ...
  Application.CreateForm(TGourmetServerServer, GourmetServerServer);
  Application.Run;
end.
