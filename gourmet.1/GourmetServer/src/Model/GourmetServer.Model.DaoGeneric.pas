unit GourmetServer.Model.DaoGeneric;
...
type
  ...
  iDAOGeneric<T: Class> = interface
    ['{386B74F7-E750-407C-ADBF-1566CE52EB57}']
...
uses GourmetServer.Model.Connection, System.SysUtils;

constructor TDAOGeneric<T>.Create;
begin
  FDataSource := TDataSource.Create(nil);
  FIndexConn := GourmetServer.Model.Connection.Connected;
  FConn := TSimpleQueryUniDac.New(GourmetServer.Model.Connection.FConnList.Items[FIndexConn]);
...
begin
  FDataSource.Free;
  GourmetServer.Model.Connection.Disconnected(FIndexConn);
  inherited;
end;
