...
type
  ...
  private
    ...
    procedure setoricodigo(const Value: string);
  ...
  published
   ...
   [campo('orcchave'), auto,PK]
    property orcchave: Integer read forcchave write setorcchave;

    [campo('oricodigo')]
    property oricodigo: string read foricodigo write setoricodigo;
...
constructor TORCNUM.create;
begin

end;

destructor TORCNUM.destroy;
begin

  inherited;
end;

procedure TORCNUM.setorcchave(const Value: Integer);
begin
  forcchave:=value;
end;

procedure TORCNUM.setorcnumeropedido(const Value: string);
begin
  forcnumeropedido:=value;
end;

procedure TORCNUM.setoricodigo(const Value: string);
begin
  foricodigo:=value;
end;
