...
type
  ...
  private
    ...
    function Getmdacodigo: Integer;

    procedure Setmespedidointegracao(const Value: String);
    function Getmespedidointegracao: String;
  ...
  public
    ...
    [Campo('mdacodigo')]
    property mdacodigo: Integer read Getmdacodigo write Setmdacodigo;

    [Campo('mespedidointegracao')]
    property mespedidointegracao: String read Getmespedidointegracao write Setmespedidointegracao;
...
procedure Tmes.Setmdacodigo(const Value: Integer);
begin
    Fmdacodigo:=value;
end;
...
function Tmes.Getmdacodigo: Integer;
begin
  result:=fmdacodigo;
end;
...
procedure Tmes.Setmespedidointegracao(const Value: String);
begin
  Fmespedidointegracao:=Value;
end;
...
function Tmes.Getmespedidointegracao: String;
begin
 Result:=Fmespedidointegracao;
end;
...
constructor TmesPedido.Create;
begin
  Limpar;
end;

destructor TmesPedido.Destroy;
begin

  inherited;
end;

function TmesPedido.Getmeschave: Integer;
begin
  Result := Fmeschave;
end;

function TmesPedido.Getmesnumeropedido: String;
begin
  Result := Fmesnumeropedido;
end;

function TmesPedido.Getoricodigo: Integer;
begin
  Result := Foricodigo;
end;

procedure TmesPedido.Limpar;
begin
  Self.meschave := 0;
  Self.oricodigo := 0;
  Self.mesnumeropedido := '';
...
procedure TmesPedido.Setmeschave(const Value: Integer);
begin
  Fmeschave := Value;
end;

procedure TmesPedido.Setmesnumeropedido(const Value: String);
begin
  Fmesnumeropedido := Value;
end;

procedure TmesPedido.Setoricodigo(const Value: Integer);
begin
  Foricodigo := Value;
end;
