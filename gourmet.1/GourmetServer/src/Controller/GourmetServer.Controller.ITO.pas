...
begin
  ...
  result :=vlitoitem;
   ...
   on E: Exception do
     begin
       result := 0;
       writeln( 'Linha 82 Controller.ITO - '+ e.Message);
     end;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      vlitochave:= vItem.getvalue('itochave', '');
      ...
      if vItem.getvalue('itooutras', '')='' then
        ito.FieldByName('itooutras').AsFloat := 0
      else
      ...
      (ito as TFDQuery).Connection.connected:=false;
   ...
   on E: Exception do
     begin
       result := 0;
       writeln( 'Linha 187 Controller.ITO - '+ e.Message);
     end;
  end;
