...
Function ManutencaoISAAplicativo(vGrpCodigo: Integer; vSbrCodigo: Integer; vIsaIdentificacao: String; vValor: string; vOrigem: Integer): Integer;
...
function BuscaListaIngredientes(vSbrCodigo: Integer): TJSonArray;
...
begin
  ...
  FDAO.dao.sql.Fields('isachave, sbrcodigo,  procodigo,  isaquantidade,  senadicionavel,  isaprincipal,  stgcodigo,  sipcodigo')
    .where('sipcodigo=1 and sbrcodigo=' + vSbrCodigo.ToString).&End.Find;

  Result := FDAO.DataSetAsJsonArray;
end;
