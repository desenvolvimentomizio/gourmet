  ...
  Begin
      ...
      begin
        ...
        begin
          ...
          vlPag := dtldtlvalor.AsCurrency -
            (dtldtlvalor.AsCurrency * (consulta.FieldByName('messervicos').AsFloat / (consulta.FieldByName('mesprodutos').AsFloat + consulta.FieldByName('messervicos').AsFloat)));
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if RoundTo(rfirfivalor.AsCurrency - (vltotServicos / rfi.RecordCount), -2) > 0.01 then
            BEGIN
              Duplicata := Cobr.Dup.Add;
              Duplicata.nDup := formatfloat('000', vlParcela);
              Duplicata.dVenc := rfirfivencimento.AsFloat;
              Duplicata.vDup := strtofloat(formatfloat('#0.00', rfirfivalor.AsCurrency - (vltotServicos / rfi.RecordCount)));
              vlTotalPag := vlTotalPag + strtofloat(formatfloat('#0.00', rfirfivalor.AsCurrency - (vltotServicos / rfi.RecordCount)));
          ...
          begin
            ...
            if vlTotalPag <> (tittitvalor.AsCurrency - vltotServicos - vlTotalDinheiro - vlTotalCartoes) then
            begin

              vlPag := vlTotalPag - (tittitvalor.AsCurrency - vltotServicos { - vlTotalDinheiro } );
    ...
    *)
    ...
    Begin
      ...
      Transp.Transporta.xNome := 'O Proprio';
    ...
    *)
    ...
    Total.ICMSTot.vNF := mesmestotal.AsCurrency - mesmesicms.AsCurrency;
