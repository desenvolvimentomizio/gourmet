...
uses
  ...
  ACBrDANFCeFortesFr, ACBrDFeUtil;
...
begin
  ...
  Begin
    ...
    ACBrNFe.NotasFiscais.Clear;
   // ACBrNFe.DANFE.ImprimeEmUmaLinha := True;
      ...
      *)
      ...
      Begin
        ...
        Begin
          ...
          Prod.vUnCom := Self.itmitmvalor.AsFloat;
...
begin
  ...
  Begin
    ...
    begin
      ...
      if vlEmitente <> vlDestinatario then
      begin

        if (cfgcfgtoemesinte.AsInteger <> 0) then
        begin
          consulta.Close;
          consulta.SQL.Text := 'select toecfopsaida from toe where toecodigo=' + cfgcfgtoemesinte.AsString;
          consulta.Open;

          vlcfop := consulta.FieldByName('toecfopsaida').AsString;

          itmncm.Close;
          itmncm.SQL.Text := 'update itm set cfocfop=' + QuotedStr(vlcfop) + '  ,toecodigo=' + cfgcfgtoemesinte.AsString + ' where itmchave=' + itmitmchave.AsString;
          itmncm.ExecSQL;
