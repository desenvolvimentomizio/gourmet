object flte: Tflte
  ...
  object plTrocos: TPanel
    ...
    object plmdatroco33: TPanel
      ...
      BevelOuter = bvNone
      BorderWidth = 1
      Caption = 'Cheques PR'#211'PRIOS R$'
      Color = 14548923
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      ...
      object edmdaTrocoChequeProprio: TDBEdit
        Left = 392
        Top = 1
        Width = 149
        Height = 23
        Align = alRight
        DataField = 'mdaTrocoChequeProprio'
        DataSource = Dtmp
        TabOrder = 1
        OnExit = aosair
        OnKeyPress = FormKeyPress
      ...
      object bttrocochequeproprios: TBitBtn
        Left = 1
        Top = 1
        Width = 391
        Height = 23
        Action = ActTrocoChequeProprios
        Align = alClient
        Caption = 'Cheque Pr'#243'prios'
        Margin = 2
        TabOrder = 2
        TabStop = False
      end
    end
    object plmdatroco22: TPanel
      Tag = 33
      Left = 0
      Top = 75
      Width = 578
      ...
      BevelOuter = bvNone
      BorderWidth = 1
      Caption = 'Cheques de TERCEIROS R$'
      Color = 14548923
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      ...
      object edmdaTrocoChequeTerceiros: TDBEdit
        Left = 392
        Top = 1
        Width = 149
        Height = 23
        Align = alRight
        DataField = 'mdaTrocoChequeTerceiros'
        DataSource = Dtmp
        TabOrder = 1
        OnExit = aosair
        OnKeyPress = FormKeyPress
      ...
      object bttrocochequeterceiros: TBitBtn
        Left = 1
        Top = 1
        Width = 391
        Height = 23
        Action = ActTrocoChequeTerceiros
        Align = alClient
    ...
    object plmdatroco11: TPanel
      ...
      object edmdaTrocoDinheiro: TDBEdit
        Left = 392
        Top = 1
        Width = 149
        Height = 23
        Align = alRight
        DataField = 'mdaTrocoDinheiro'
        DataSource = Dtmp
        TabOrder = 1
        OnExit = aosair
        OnKeyPress = FormKeyPress
    ...
    object plmdatrocotit: TPanel
      ...
      BevelOuter = bvNone
      BorderWidth = 2
      Caption = 'Defini'#231#227'o de TROCOS'
      Color = 12615680
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -15
    ...
    object plmdatroco77: TPanel
      ...
      object edmdaTrocovale: TDBEdit
        Left = 392
        Top = 1
        Width = 149
        Height = 23
        Align = alRight
        DataField = 'mdaTrocoVale'
        DataSource = Dtmp
        ReadOnly = True
        TabOrder = 1
        OnExit = aosair
  ...
  object plcreditos: TPanel
    ...
    object edmdaCredito: TDBEdit
      Left = 392
      Top = 1
      Width = 149
      Height = 23
      Align = alRight
      DataField = 'mdaCredito'
      DataSource = Dtmp
      Enabled = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
    ...
    object btcreditos: TBitBtn
      ...
      Action = ActCreditos
      Align = alClient
      Caption = 'CR'#201'DITOS R$'
      Margin = 2
      TabOrder = 2
      TabStop = False
    end
  end
  object pltrocadevolucao: TPanel
    Tag = 8
    Left = 0
    Top = 453
    Width = 578
    ...
    object edmdaTrocaDevolucao: TDBEdit
      Left = 392
      Top = 1
      Width = 149
      Height = 28
      Align = alRight
      DataField = 'mdaTrocaDevolucao'
      DataSource = Dtmp
      Enabled = False
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
    ...
    object btrocadevolucao: TBitBtn
      Left = 1
      Top = 1
      Width = 391
      Height = 28
      Action = ActTrocaDevolucao
      Align = alClient
  ...
  object plaFaturar: TPanel
    ...
    object edmdaAFaturar: TDBEdit
      Left = 392
      Top = 1
      Width = 149
      Height = 23
      Align = alRight
      DataField = 'mdaAFaturar'
      DataSource = Dtmp
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
  ...
  object plContraVale: TPanel
    ...
    TabOrder = 17
    Visible = False
    object plValorContraVale: TPanel
      Left = 392
      Top = 4
      Width = 146
      Height = 17
  ...
  object edmdaOnline: TDBEdit
    Left = 224
    Top = 761
    Width = 149
    Height = 26
    TabStop = False
    DataField = 'mdaGarantia'
    DataSource = Dtmp
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
  ...
  object lte: TUniQuery
    SQL.Strings = (
      ...
      '     , lte.ccxchave'
      '  FROM lte'
      '  ORDER BY lte.ltechave ASC LIMIT 1')
    Left = 12
    Top = 652
  ...
  object dtl: TUniQuery
    SQL.Strings = (
        ...
        'select dtlchave, ltechave, cedcodigo, mdacodigo, dtlvalor, dtlva' +
        'lorinfo, flacodigo, ccxchave, dtlregistro, rdcnrauto from dtl wh' +
        'ere ltechave=:ltechave and flacodigo=:flacodigo')
  ...
  object tmp: TVirtualTable
    FieldDefs = <
      ...
      item
        Name = 'mdaChequeProprio'
        DataType = ftFloat
        Precision = 15
      end
      item
        Name = 'mdaChequeTerceiros'
        DataType = ftFloat
        Precision = 15
      end
      item
        Name = 'mdaCartaoDebito'
        DataType = ftFloat
        Precision = 15
      end
      item
        Name = 'mdaCartaoCredito'
        DataType = ftFloat
        Precision = 15
      end
      item
      ...
      item
        Name = 'mdaTrocoDinheiro'
        DataType = ftFloat
        Precision = 15
      end
      item
        Name = 'mdaTrocoChequeProprio'
        DataType = ftFloat
        Precision = 15
      end
      item
        Name = 'mdaTrocoChequeTerceiros'
        DataType = ftFloat
        Precision = 15
      end
      item
    ...
    Top = 12
    Data = {
      
      000000000000000000}
    ...
    object tmpmdaCredito: TFloatField
      Tag = 8
      FieldName = 'mdaCredito'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdatrocadevolucao: TFloatField
      Tag = 15
      FieldName = 'mdaTrocaDevolucao'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaDoacao: TFloatField
      Tag = 16
      FieldName = 'mdaDoacao'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaOnline: TFloatField
      Tag = 78
      FieldName = 'mdaGarantia'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaVale: TFloatField
      Tag = 17
      FieldName = 'mdaVale'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaPix: TFloatField
      Tag = 6
      FieldName = 'mdaPix'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaTrocoDinheiro: TFloatField
      Tag = 11
      FieldName = 'mdaTrocoDinheiro'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaTrocoChequeProprio: TFloatField
      Tag = 22
      FieldName = 'mdaTrocoChequeProprio'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaTrocoChequeTerceiros: TFloatField
      Tag = 33
      FieldName = 'mdaTrocoChequeTerceiros'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object tmpmdaTrocoVale: TFloatField
      Tag = 77
      FieldName = 'mdaTrocoVale'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
  ...
  object mlt: TUniQuery
    SQL.Strings = (
        ...
        'select mltchave,mfichave, ltechave,flacodigo from mlt where mfic' +
        'have=:mfichave')
    Left = 210
    Top = 588
    ParamData = <
  ...
  object mes: TUniQuery
    SQL.Strings = (
        ...
        'select meschave,etdcodigo, flacodigo from mes where meschave=:me' +
        'schave and flacodigo=:flacodigo')
    Left = 328
    Top = 700
    ParamData = <
      item
  ...
  object cco: TUniQuery
    SQL.Strings = (
      ...
      '     , flacodigo'
      'FROM cco'
      'WHERE cco.ccochave = :ccochave and cco.flacodigo=:flacodigo')
    AfterPost = ccoAfterPost
    Left = 156
    Top = 777
    ParamData = <
      item
  ...
  object rfm: TUniQuery
    SQL.Strings = (
        ...
        'select  rfmchave, rfichave, meschave, flacodigo from rfm where r' +
        'fichave=:rfichave')
    Left = 212
    Top = 629
    ParamData = <
  ...
  object AcoesLote: TActionList
    ...
    object ActCreditos: TAction
      Tag = 8
      Caption = 'Cr'#233'ditos'
      ShortCut = 120
      OnExecute = ActCreditosExecute
    end
    object ActTrocaDevolucao: TAction
      Tag = 15
      Caption = 'Troca / Devolu'#231#227'o'
      OnExecute = ActTrocaDevolucaoExecute
    end
    ...
    object ActVale: TAction
      Tag = 17
      Caption = 'Vale'
      OnExecute = ActValeExecute
    end
    object ActTrocoDinheiro: TAction
      Tag = 11
      Caption = 'Troco Dinheiro'
      ShortCut = 121
      OnExecute = ActTrocoDinheiroExecute
    end
    object ActTrocoChequeTerceiros: TAction
      Tag = 33
      Caption = 'Cheque Terceiros'
      ShortCut = 123
      OnExecute = ActTrocoChequeTerceirosExecute
    end
    object ActTrocoChequeProprios: TAction
      Tag = 22
      Caption = 'Cheque Pr'#243'prios'
      ShortCut = 122
      OnExecute = ActTrocoChequePropriosExecute
    end
    object ActTrocoVale: TAction
      Tag = 77
      Caption = 'ActTrocoVale'
      ShortCut = 113
      OnExecute = ActTrocoValeExecute
    end
  end
  ...
  object adc: TUniQuery
    SQL.Strings = (
        ...
        'select adccodigo, adcliquidaautomatico, ctacodigo from adc WHERE' +
        ' adcencerramento IS null')
    Left = 140
    Top = 680
  ...
  object ltetr: TUniQuery
    ...
    Left = 256
    Top = 360
    object ltetrltechave: TIntegerField
      FieldName = 'ltechave'
    end
    object ltetrtfdcodigo: TIntegerField
      FieldName = 'tfdcodigo'
    end
    object ltetrltedata: TDateField
      DisplayLabel = 'Data do Registro'
      FieldName = 'ltedata'
    end
    object ltetrlteprincipal: TFloatField
      DisplayLabel = 'Valor R$'
      FieldName = 'lteprincipal'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object ltetrltemulta: TFloatField
      DisplayLabel = 'Valor da Multa R$'
      FieldName = 'ltemulta'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object ltetrltejuros: TFloatField
      DisplayLabel = 'Valor do Juros R$'
      FieldName = 'ltejuros'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object ltetrltedesconto: TFloatField
      DisplayLabel = 'Valor do Desconto R$'
      FieldName = 'ltedesconto'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object ltetrltetotal: TFloatField
      DisplayLabel = 'Total L'#237'quido R$'
      FieldName = 'ltetotal'
      DisplayFormat = '#,##0.00'
      EditFormat = '#,##0.00'
    end
    object ltetrlteextenso: TStringField
      FieldName = 'lteextenso'
      Size = 2000
    end
    object ltetrflacodigo: TIntegerField
      FieldName = 'flacodigo'
    end
  end
  object dtltr: TUniQuery
    SQL.Strings = (
      'SELECT'
      '  dtlchave,'
      '  ltechave,'
    ...
    Left = 184
    Top = 463
    object dtltrdtlchave: TIntegerField
      FieldName = 'dtlchave'
    end
    object dtltrltechave: TIntegerField
      FieldName = 'ltechave'
    end
    object dtltrcedcodigo: TIntegerField
      FieldName = 'cedcodigo'
    end
    object dtltrdtlvalor: TFloatField
      FieldName = 'dtlvalor'
    end
    object dtltrmdacodigo: TIntegerField
      FieldName = 'mdacodigo'
    end
    object dtltrflacodigo: TIntegerField
      FieldName = 'flacodigo'
    end
  end
  object let: TUniQuery
    SQL.Strings = (
      ...
      '  v_rcr.rcrsaldo'
        ...
        'FROM let,v_rcr  where v_rcr.etdcodigo=let.etdcodigo and v_rcr.rc' +
        'rsaldo>0'
  ...
  object lcv: TUniQuery
    SQL.Strings = (
      ...
      '  mcr.mcrvalor'
        ...
        'FROM lcv,mcr where lcv.mcrchave=mcr.mcrchave and ltechave=:ltech' +
        'ave')
    Left = 252
    Top = 312
    ParamData = <
    ...
    object lcvmcrvalor: TFloatField
      FieldName = 'mcrvalor'
    end
  end
  object vlet: TUniQuery
    SQL.Strings = (
      'select'
      '  letchave,'
      '  ltechave,'
      '  etdcodigo'
      '  from let where ltechave=:ltechave and etdcodigo=:etdcodigo')
    Left = 168
    Top = 516
    ParamData = <
      item
    ...
    object vletletchave: TIntegerField
      FieldName = 'letchave'
    end
    object vletltechave: TIntegerField
      FieldName = 'ltechave'
    end
    object vletetdcodigo: TIntegerField
      FieldName = 'etdcodigo'
    end
  end
  ...
  object limite: TUniQuery
    ...
    object limiteetldescontopadrao: TFloatField
  ...
  object ets: TUniQuery
    SQL.Strings = (
      ...
      '  tse.tseidentificacao'
        ...
        'FROM ets, tse where ets.tsecodigo=tse.tsecodigo and etdcodigo=:e' +
        'tdcodigo order by ets.etscodigo desc limit 1')
    Left = 256
    Top = 495
    ParamData = <
      item
  ...
  object mcgrfi: TUniQuery
    SQL.Strings = (
      ...
      '     '
      'WHERE '
      '  rfi.titcodigo=mcg.mcgchaveorigem AND '
      '  mcg.mcgtabela='#39'rfi'#39' AND '
  ...
  object dtlmes: TUniQuery
    ...
    object dtlmesccxchave: TIntegerField
      FieldName = 'ccxchave'
    end
  end
  ...
  object orc: TUniQuery
    ...
    object orcorchoraencerr: TTimeField
      FieldName = 'orchoraencerr'
    end
    object orcclbcaixa: TIntegerField
      FieldName = 'clbcaixa'
    end
    ...
    object orcfoacodigo: TIntegerField
      FieldName = 'foacodigo'
    end
    ...
    object orcclbencerrou: TIntegerField
      FieldName = 'clbencerrou'
    end
    object orcorcdataentrega: TDateField
      FieldName = 'orcdataentrega'
      EditMask = '!99/99/9999;1;_'
    end
    object orcorchoraentrega: TTimeField
      FieldName = 'orchoraentrega'
      EditMask = '!90:00;1;_'
    end
    object orcedrcodigoentrega: TIntegerField
      FieldName = 'edrcodigoentrega'
    end
  ...
  object lito: TUniQuery
    ...
    object litovrpcodigo: TIntegerField
      FieldName = 'vrpcodigo'
    end
    object litoitoacrescimovalor: TFloatField
      DisplayLabel = 'Valor R$'
      FieldName = 'itoacrescimovalor'
    end
    object litoitoacrescimototal: TFloatField
      DisplayLabel = 'Total R$'
      FieldName = 'itoacrescimototal'
    end
    object litoitoacrescimosaldo: TFloatField
      DisplayLabel = 'Sakdo R$'
      FieldName = 'itoacrescimosaldo'
    end
    object litoitopercentualcombo: TFloatField
      FieldName = 'itopercentualcombo'
    end
  end
  object zPCalcDescAV: TUniSQL
    SQL.Strings = (
      ...
      'UPDATE ito, pro'
        ...
        'SET itodescontoav = ROUND((@Desconto * (itototalav / @Total)), 2' +
        '),'
      
        '    ito.itopercdescav = (ito.itodescontoav / ito.itototalav) * 1' +
        '00,'
      '    tdecodigo = 1'
      'WHERE ito.procodigo = pro.procodigo'
      'AND ito.stocodigo NOT IN (8, 88)'
      ...
      ''
        ...
        '/*Trata Diferen'#231'a de valor definido para desconto e valor calcul' +
        'ado*/'
      'SET @DifDesconto = @Desconto - (SELECT'
      '    ROUND(SUM(itodescontoav), 2)'
      '  FROM ito'
      ...
      '  AND pro.tpocodigo <> 9'
      '  AND orcchave = @OrcChave'
      '  ORDER BY (itototalav / @Total) DESC LIMIT 1);'
      ''
      ''
      'UPDATE ito, pro'
      'SET itodescontoav = (itodescontoav + @DifDesconto),'
      
        '    ito.itopercdescav = (ito.itodescontoav / ito.itototalav) * 1' +
        '00'
      'WHERE ito.procodigo = pro.procodigo'
      'AND pro.tpocodigo <> 9'
      'AND itochave = @ChaveMaiorPerc;')
    Left = 342
    Top = 212
    ParamData = <
      item
  ...
  object ito: TUniQuery
    ...
    object itotdfcodigo: TStringField
      FieldName = 'tdfcodigo'
      Size = 2
    end
    object itoflacodigo: TIntegerField
      FieldName = 'flacodigo'
    end
    object itopmpchave: TIntegerField
      FieldName = 'pmpchave'
    end
    object itoitoacrescimoav: TFloatField
      FieldName = 'itoacrescimoav'
    end
    object itoclbatendente: TIntegerField
      FieldName = 'clbatendente'
    end
    object itoitoitempedido: TStringField
      FieldName = 'itoitempedido'
    end
  end
end
