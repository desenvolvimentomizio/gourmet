...
type
  Tfmcfgmsai = class(Tfrmbase)
    ...
    Label81: TLabel;
    cfgtributacaoimendes: TDBEdit;
    Label6: TLabel;
    cfgunitrib: TDBEdit;
    registrocfgtributacaoimendes: TIntegerField;
    registrosencfgtributacaoimendes: TStringField;
...
begin
  registrocfgdoisprecos.AsInteger := 0;
  registrocfgusafabricante.AsInteger := 0;
  registrocfgusaenderecamento.AsInteger := 0;
  registrocfgprousaanpcodigo.AsInteger := 0;
  registrocfgprocodigoauto.AsInteger := 1;
  registrocfgusagrade.AsInteger := 0;
  registrocfgusatabelaspreco.AsInteger := 0;
  registrocfgusaprecobase.AsInteger := 0;
  registrocfgtabelasaux.AsInteger := 0;
  registrocfgdiferencialaliquota.AsInteger := 0;
  registrocfgpercentacresaprazo.AsInteger := 0;
  registrocfgprousainfcompl.AsInteger := 0;
  registrocfgmodoatuapro.AsInteger := 1;
  registrocfgproinativsaldozero.AsInteger := 0;
  registrocfgmostrapercentuais.AsInteger := 0;
  registrocfgcontrolaestoque.AsInteger := 0;
  registrocfgcontrolaestoquedisp.AsInteger := 0;

  if registrocfgtributacaoimendes.AsInteger = 1 then
  begin
    registrocfgprodefineicms.AsInteger := 1;
    registrocfgusacstnoproduto.AsInteger := 1;
    registrocfgusacsinoproduto.AsInteger := 1;
    registrocfgusacspnoproduto.AsInteger := 1;
    registrocfgusacsfnoproduto.AsInteger := 1;
  end;
...
begin
  ...
  Self.registrocfgcontrolaestoque.AsInteger := 0;
  Self.registrocfgcontrolaestoquedisp.AsInteger := 0;
