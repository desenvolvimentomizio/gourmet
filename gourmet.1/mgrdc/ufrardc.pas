...
begin
  inherited;
  CriaFormulario(Tfgrrdc, Self.uqtabelardcchave.AsString, IntToStr(FMdaCodigo));
end;
...
begin
  inherited;
  if CriaFormulario(Tfgrrdc, '', IntToStr(FMdaCodigo)) then
  begin
...
procedure Tfrardc.SetMdaCodigo(const Value: Integer);
begin
  FMdaCodigo := Value;
end;
