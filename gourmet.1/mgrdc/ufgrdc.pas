...
procedure Tfgrdc.FormShow(Sender: TObject);
begin
  Self.Height := 250;
  Self.Width := 390;
...
procedure Tfgrdc.rdcparcelasExit(Sender: TObject);
begin
...
procedure Tfgrdc.registroAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure Tfgrdc.registroBeforePost(DataSet: TDataSet);
begin
  inherited;
