...
const
  ...
  vpIpServidorRemoto = '216.238.107.72';
...
begin
  try
    ...
    ConexaoWeb.Server := 'miziossistemas.com.br';
    ConexaoWeb.Port := 2007;
    ConexaoWeb.Username := 'mizios_versoes';
    ConexaoWeb.Database := 'mizios_versoes';
    ...
    try
      ...
      begin
        ...
        begin
          ...
          vlverarquivoLocal := extractfilepath(application.ExeName) + versoes.FieldByName('verpasta').AsString + '\' +
            versoes.FieldByName('verarquivo').AsString;
