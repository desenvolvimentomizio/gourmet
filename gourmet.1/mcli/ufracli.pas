...
begin
  ...
  if pos(' group by etd.etdcodigo ',uqtabela.sql.Text)=0 then
   uqtabela.sql.Text:= StringReplace(uqtabela.sql.Text, ' group by etd.etdcodigo ','',[])
  else
   uqtabela.sql.Text:=  uqtabela.sql.Text+ ' group by etd.etdcodigo ';
