            ...
            begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      (self.FindComponent('plimp' + vTciCodigo) as TPanel).Color := clgreen;
                      (self.FindComponent('plimp' + vTciCodigo) as TPanel).Font.Color := clWhite;
                      (self.FindComponent('plimp' + vTciCodigo) as TPanel).Caption := viIdentificacao;
                    end
                    else
                    begin
              ...
              2:
                begin
                  ...
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Caption := viIdentificacao + ' ( POUCO PAPEL' + ' )';
                end;
              7:
                begin
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Color := clGray;
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Font.Color := clred;
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Caption := viIdentificacao + ' ( TAMPA ABERTA' + ' )';
                end;
              3:
                begin
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Color := clblack;
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Font.Color := clred;
                  (self.FindComponent('plimp' + vTciCodigo) as TPanel).Caption := viIdentificacao + ' ( SEM PAPEL' + ' )';
                end;
              end;
