  ...
  try
    try
      ...
      begin
        ...
        tabelarfisaldogeral.AsCurrency := tabelarfisaldocapital.AsCurrency + tabelarfimulta.AsCurrency + tabelarfijuros.AsCurrency - tabelarfidesconto.AsCurrency;
        tabela.Post;
        tabela.Next;
      end;
