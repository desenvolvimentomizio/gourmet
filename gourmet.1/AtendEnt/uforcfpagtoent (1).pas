    ...
    begin
      ...
      begin
        ...
        begin
          ...
          { FprinciEnt.vchvchvoucher: TStringField
            FprinciEnt.vchvchtipo: TIntegerField
            FprinciEnt.vchvchmodouso: TIntegerField
            FprinciEnt.vchvchdatavalidade: TDateField
            FprinciEnt.vchvchvalor: TFloatField
            FprinciEnt.vchvchpercentual: TFloatField
            FprinciEnt.vchetdcodigo: TIntegerField
            FprinciEnt.vchvchdatauso: TDateField }
...
begin
  ...
  begin
...

    {
      ...
      if FprinciEnt.cfgcfgdescontonoservico.AsInteger = 0 then
      FprinciEnt.zPCalcDescAV.SQL.add('  AND pro.tpocodigo <> 9 ');
      ...
      FprinciEnt.zPCalcDescAV.SQL.add('');
      FprinciEnt.zPCalcDescAV.SQL.add('UPDATE ito, pro ');
      FprinciEnt.zPCalcDescAV.SQL.add('SET itodescontoav = ROUND((@Desconto * (itototalav / @Total)), 2), ');
      FprinciEnt.zPCalcDescAV.SQL.add('    ito.itopercdescav = (ito.itodescontoav / (ito.itototalav)) * 100, ');
      FprinciEnt.zPCalcDescAV.SQL.add('    tdecodigo = 1 ');
      FprinciEnt.zPCalcDescAV.SQL.add('WHERE ito.procodigo = pro.procodigo ');
      FprinciEnt.zPCalcDescAV.SQL.add('AND ito.stocodigo NOT IN (8, 88) ');
