...
uses Winapi.Windows, System.Classes, System.Variants, System.Win.StdVCL, Vcl.Graphics, Vcl.OleCtrls,
     Vcl.OleServer, Winapi.ActiveX,
     WinApi.Messages, Winapi.Mshtmhst, Vcl.Controls, Vcl.StdCtrls, Vcl.Forms, Vcl.Edge1, WebView2;
...
// *********************************************************************//
  ...
  protected
    ...
    function GetEdgeInterface: TEdgeBrowser1;
  public
  ...
  begin
    ...
    case FSelectedEngine of
      ...
      begin
        ...
        if FEdge = nil then
          FEdge := TEdgeBrowser1.Create(Self);
...
function TWebBrowser.GetEdgeInterface: TEdgeBrowser1;
begin
  if (FEdge = nil) and
