...
uses
  ...
  IdExplicitTLSClientServerBase, IdFTP, UniProvider, MySQLUniProvider, DAScript,
  UniScript, DADump, UniDump, Vcl.ExtCtrls, IdIOHandler, IdIOHandlerStream,
  IdZLibCompressorBase, IdCompressorZLib, IdUDPBase, IdUDPClient, IdTrivialFTP,
  IdRawBase, IdRawClient, IdIcmpClient, IdTraceRoute, Datasnap.Provider, forms;

type
  TconexaoDM = class(TDataModule)
    gab: TUniQuery;
    cfg: TUniQuery;
    cfgcfgdoc1: TStringField;
    cfgetdapelido: TStringField;
    conexaoweb: TUniConnection;
    local: TUniConnection;
...
uses funcoesbackup, uAutoBackup, uConfigura, uThreadExec;
