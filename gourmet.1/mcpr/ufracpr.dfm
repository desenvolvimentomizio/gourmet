inherited fracpr: Tfracpr
  ...
  inherited acoes: TActionList
    ...
    object ActTransferencia: TAction [2]
      Category = 'Entradas'
    ...
    inherited ActFiltrar: TAction [5]
      Category = 'Entradas'
    end
  ...
  inherited MadExceptionHandler1: TMadExceptionHandler
    Left = 248
  end
  object itm: TUniQuery
    SQL.Strings = (
      ...
      '     , itm.itmvalor'
      '     , itm.itmcontendo'
      '     , itm.itmquantidade * itm.itmcontendo itmquantidadeitem'
    ...
    object itmitmquantidadeitem: TFloatField
  ...
  object uqItmTotais: TUniQuery
    SQL.Strings = (
      ...
      '     , SUM(itm.itmdesconto)                AS itmdesconto'
        ...
        '     , SUM((itm.itmtotal+itm.itmipi+itm.itmfrete) - itm.itmdesco' +
        'nto) AS itmtotalliq'
      '  FROM itm'
      ' INNER JOIN pro ON itm.procodigo = pro.procodigo'
      ' INNER JOIN pun ON itm.puncodigo = pun.puncodigo'
  ...
  object xml: TUniQuery
    SQL.Strings = (
      
        'select meschave from mesxml where meschave=:meschave and mesarqx' +
        'ml is not null')
    Left = 872
    Top = 355
    ParamData = <
