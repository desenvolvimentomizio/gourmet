...
begin
  ...
  begin
    ...
    if ((FindWindow(PChar('TFprinciPdv'), nil)) <> 0)  or  ((FindWindow(PChar('Tfprincirest'), nil)) <> 0) or ((FindWindow(PChar('TFprinciVar'), nil)) <> 0) or ((FindWindow(PChar('TFprinciCax'), nil)) <> 0) then
    begin
