...
uses
  ...
  DateUtils,
  System.SysUtils, GourmetAIQ.Service.Log, GourmetAIQ.Service.HealthMonitor;
...
begin
  try
    ...
    HealthMonitor.Track('AIQ.MarcarPronto',
      procedure
      begin
        try
...
begin
  try
    ...
    Log.Info('MarcaPedidoLidoAIQ: pedido=' + vPedido);


    HealthMonitor.Track('AIQ.MarcarLido',
      procedure
      begin
        try
          vlDMPedidoAIQ.RESTRequestAIQ.Execute;
    ...
    Log.Info('MarcaPedidoLidoAIQ: status=' + vlDMPedidoAIQ.RESTResponseAIQ.StatusCode.ToString);
...
begin
  ...
  try
   ...
   // vlDMPedidoAIQ.RESTRequestAIQ.Body.Add('{"order_id": ' + vPedido + ' }', TRESTContentType.ctAPPLICATION_JSON);
    ...
    HealthMonitor.Track('AIQ.PedidoDetalhe',
      procedure
      begin
        try
          vlDMPedidoAIQ.RESTRequestAIQ.Execute;
...
begin
  ...
  try
    ...
    vlDMPedidoAIQ.RESTRequestAIQ.Method := TRESTRequestMethod.rmGET;
    HealthMonitor.Track('AIQ.PedidosLista',
      procedure
      begin
        try
          vlDMPedidoAIQ.RESTRequestAIQ.Execute;
    ...
    begin
      ...
      begin
        ...
        if not vPedidosAIQ.Active then
           vPedidosAIQ.Open;
