...
var
 ...
 // ********************************
 // chaves aiqfome nova api
 // Client Id:   P7S3bJTXcflBHbrbq4MWGGpMCoiswWrCT15sfN3ifdg
 // Client Secret: 6ub6i2WVYAJl5zmScX47Ol53T4DJtRznMBBFiUGdg0M
 // ********************************
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (PedidosRegistradosaiqstatus.AsInteger = 2) and (PedidosProcessadossaida.AsString <> '') then
        begin
