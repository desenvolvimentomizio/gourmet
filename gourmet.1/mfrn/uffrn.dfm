inherited ffrn: Tffrn
  ...
  inherited paginas: TPageControl
    ...
    object DadosFiscais: TTabSheet
      ...
      object etdsuframa: TDBEdit
        Left = 136
        Top = 57
        Width = 125
        Height = 21
        CustomHint = BalloonHint
        DataField = 'etdsuframa'
        DataSource = DSRegistro
        TabOrder = 2
        Visible = False
      end
  ...
  object etv: TUniQuery
    SQL.Strings = (
      'select etvcodigo, etdcodigo, tvicodigo, pcgcodigo from etv')
