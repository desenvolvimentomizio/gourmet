...
function Tfprincigereimpgoufast03.enviaBMPImpressora(vlNumePedido: Integer; vporta: string; vlRetorno: Integer; vlimms: string;
...
procedure Tfprincigereimpgoufast03.FormCreate(Sender: TObject);
begin
...
function Tfprincigereimpgoufast03.ImprimePedido(vOrcChave: string; vFoaCodigo: string; vrelarquivo: TBlobField; vimmorigem: TUniQuery;
...
Begin
  ...
  try
    ...
    ACBrPosPrinter1.Modelo := ModeloACBrPorTip(TipCodigoDaPorta(ZCone, vporta));
