...
type
  ...
  private
    ...
    procedure VerificaPedidosImpressora03(vImpressora: string; vIP: string);
...
procedure Tfprincigereimpgoufast.Timer1Timer(Sender: TObject);
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        consulta.SQL.Text :=
          'select gri.tcicodigo, grisituacao from gri,tci,mit where  gri.tcicodigo=tci.tcicodigo  and  mit.mitcodigo=tci.mitcodigo  and mitidentificacao='
          + QuotedStr(vpImpressora03);
        consulta.Open;

        Application.ProcessMessages;
        VerificaPedidosImpressora03(vpImpressora03, vpIPImpressora03);
...
procedure Tfprincigereimpgoufast.VerificaPedidosImpressora03(vImpressora: string; vIP: string);
var
  vlpedido: string;
...
begin
  ...
  begin
    ...
    fprincigereimpgoufast03 := Tfprincigereimpgoufast03.Create(self);
    fprincigereimpgoufast03.plsituacao.Color := clgreen;
    fprincigereimpgoufast03.top := 0;
    fprincigereimpgoufast03.Left := 60;

    fprincigereimpgoufast03.Parent := Panel5;
    fprincigereimpgoufast03.Caption := 'Imprimindo ' + vIP;
    fprincigereimpgoufast03.vpImpressora := vImpressora;
    fprincigereimpgoufast03.ZCone := Conexao;
    fprincigereimpgoufast03.frxUniDACComponents.DefaultDatabase := Conexao;
    fprincigereimpgoufast03.inicializar.Enabled := True;
    fprincigereimpgoufast03.ShowModal;
