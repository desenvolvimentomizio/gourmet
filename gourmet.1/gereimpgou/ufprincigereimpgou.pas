        ...
        begin
          ...
          begin
            ...
            begin
              ...
              (self.FindComponent('plimp' + vTciCodigo) as TPanel).Caption := vlIdentificacao + ' ( FALHA COMUNICA��O' + ' )';
            end;
...
function TfPrinciGereImpGou.enviaBMPImpressoraaux(vlNumePedido: Integer; vporta: string; vlRetorno: Integer; vlimms: string;
...
function TfPrinciGereImpGou.enviaBMPImpressora(vlNumePedido: Integer; vporta: string; vlRetorno: Integer; vlimms: string; vTciCodigo: string)
  : Boolean;
var
  vlArqBmp: string;
  vlArqFast: string;
...
begin
  ...
  begin
    ...
    RunOnStartup('Gerenciador Impress�o Mizio Sistemas', Application.ExeName, false);
...
Begin
  ...
  begin
    ShowMessage('Falha de conex�o com o Banco de Dados. Verifique as configura��es do mizio.ini');
          ...
          begin
            ...
            begin
              ...
              consulta.SQL.Text := 'update imm set tcicodigo=' + vlTciCodigo +
                ' ,immhoraimpresso=null where immchave in (select immchave from tped where orcchave=' + vOrcChave + ' and immnumepedido=' +
              ...
              begin
                ...
                begin
                  ...
                  erros.Lines.Add('Tentativa: ' + inttostr(vlTentativas) + ' Orc.: ' + vlOrcChave + ' Ped.: ' + inttostr(vlNumePedido) + ' Imp.: ' +
                    vlTciCodigo);
                  sleep(500);

                  if vlTentativas = 2 then
                  begin
                    erros.Lines.Add('N�o foi possivel a impress�o Orc.: ' + vlOrcChave + ' Ped.: ' + inttostr(vlNumePedido) + ' Imp.: ' +
                      vlTciCodigo);
...
begin
  ...
  begin
    ...
    begin
      ...
      consulta.close;
      consulta.SQL.Text := 'update imm set immhoraimpresso=NOW() where immchave in (select immchave from tped where orcchave=' + vOrcChave +
        ' and immnumepedido=' + inttostr(vlNumePedido) + ' and tcicodigo=' + vlTciCodigo + ')';
      consulta.ExecSQL;
      result := True;
      exit;
...
Begin
  { Substitui ConfiguraModeloImpressora/IniciaPorta/Le_Status/FechaPorta da
    MP2032.DLL. O Modelo e definido conforme o tipo (tip) da impressora.
