...
begin
  ...
  fbolgeb.consulta.SQL.Text :=
    'SELECT rfi.rfichave, gbr.gebcodigo,carcodigo FROM rfi, gbr WHERE rfi.rfichave=gbr.rfichave and rfi.titcodigo = :titcodigo and flacodigo=:flacodigo';
...
begin
  consulta.Close;
  consulta.SQL.Text :=
    'SELECT rfi.rfichave, gbr.gbrcodigo FROM rfi, gbr WHERE gbr.rfichave=rfi.rfichave and titcodigo = :titcodigo and rfi.flacodigo=:flacodigo';
...
begin
  ...
  begin
    ...
    begin
      fbolgeb.consulta.Close;
      fbolgeb.consulta.SQL.Text := 'select rfi.carcodigo from rfi, tit where rfi.titcodigo=tit.titcodigo and tit.titcodigo=' + Inttostr(Titulo) +
        ' and rfi.flacodigo=' + Acesso.Filial.ToString;
      fbolgeb.consulta.Open;
...
type
  TBuscaParcelas = function(AOwner: TComponent; Conexao: TUniConnection; vUsuario: string; Acesso: TAcesso; vGebCodigo: Integer;
