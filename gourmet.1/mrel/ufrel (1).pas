...
var
  ...
  I: integer;
begin
  if (relidentificacao.Field.AsString = '') or (reltitulo.Field.AsString = '') or (relusaparametros.Field.AsString = '') or (relsituacao.Field.AsString = '')
  then
  begin
...
begin
  ...
  vlRelCodigo := consulta.Fields[0].AsInteger + 1;

  vlRadCNPJ := SoNumeros(cfgetddoc1.AsString);
  vlRadCNPJ := formatfloat('00000000', strtofloat(copy(vlRadCNPJ, 1, 8)));
  registrorelcodigo.AsString := formatfloat('000', vlRelCodigo) + vlRadCNPJ;
