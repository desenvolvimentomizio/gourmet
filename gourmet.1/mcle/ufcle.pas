...
type
  Tfcle = class(Tfrmbase)
    ...
    procedure CbFormaEntregaChange(Sender: TObject);
  private
...
begin
 ...
 if (etddoc1.Field.AsString = '') or  (etddoc1.Field.AsString = '0')  then
  begin
...
procedure Tfcle.CbFormaEntregaChange(Sender: TObject);
begin
  inherited;
if (etddoc1.Field.AsString = '') or  (etddoc1.Field.AsString = '0')  then
  begin
