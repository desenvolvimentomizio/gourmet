...
begin
  ...
  begin
    ...
    if vlNivel = 4 then
    begin
      vlRelCodigo := copy(ArvoreMenu.Items[Contador].Text, 1, 11);
      vlRelCodigo := SoNumeros(vlRelCodigo);
      ...
      begin
        ...
        ajustadireitos.FieldByName('rauativo').AsInteger := ArvoreMenu.Items[Contador].ImageIndex;
        ajustadireitos.post;
      end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ajustadireitos.FieldByName('dauativo').AsInteger := ArvoreMenu.Items[Contador].ImageIndex;
          ajustadireitos.post;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (pos('relat', semacento(trim(lowercase(actactidentificacao.AsString)))) > 0) and (pos('fprinci', lowercase(actactformulario.AsString))=0) then
          begin
            mre.Close;
            ...
            begin
              ...
              begin
                ...
                begin
                  vlItemMenu := relrelcodigo.AsString + ' ' + relrelidentificacao.AsString;
          ...
          begin
            ...
            vlItemMenu := formatfloat('0000', actactcodigo.AsInteger) + ' ' + copy(actactidentificacao.AsString, 5, 200);
