...
begin
  try
    ...
    // Pega posição atual do cursor na tela
  //GetCursorPos(P);

  // Converte para coordenadas do botão
  //P := (Sender as TBitBtn).ScreenToClient(P);

  // Verifica se o cursor está dentro da área do botão
  // if PtInRect((Sender as TBitBtn).ClientRect, P)=False then
  //  exit;
