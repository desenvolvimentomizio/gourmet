...
begin
  ...
  if MessageDlg('Confirma exclusão do adicional selecionado?', mtConfirmation, [mbYes, mbNo], 0, mbNo) = IdYes then
  begin
    DmDados.dvtsbradc.dataset.delete;
  end;
...
procedure TFrmIngredienteComum.Button7Click(Sender: TObject);
begin
