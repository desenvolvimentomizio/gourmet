object fstonehide: Tfstonehide
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object btDetalheRecebimento: TButton
        Left = 810
        Top = 0
        Width = 20
        Height = 20
        ...
        ParentFont = False
        TabOrder = 0
        OnClick = btDetalheRecebimentoClick
      end
    end
  end
  ...
  object mor: TUniQuery
    SQL.Strings = (
        ...
        'select morchave, mor.orcchave, mor.meschave, orc.stocodigo from ' +
        'mor,orc where orc.orcchave=mor.orcchave and mor.orcchave=:orccha' +
        've')
    Left = 384
    Top = 384
    ParamData = <
    ...
    object morstocodigo: TIntegerField
      FieldName = 'stocodigo'
    end
  end
  ...
  object mfilte: TUniQuery
    Connection = DmDados.Conexao
    Left = 272
    Top = 432
  end
  object mormes: TUniQuery
    Connection = DmDados.Conexao
    SQL.Strings = (
      'SELECT'
      '  morchave,'
