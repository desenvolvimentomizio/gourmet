...
procedure TfVndAcm.bconfirmaClick(Sender: TObject);
begin
  inherited;
...
procedure TfVndAcm.FormShow(Sender: TObject);
begin
...
procedure TfVndAcm.SetAcmTipo(const Value: String);
begin
  FAcmTipo := Value;
...
procedure TfVndAcm.SetItmChave(const Value: String);
begin
  FItmChave := Value;
end;

procedure TfVndAcm.SetMesChave(const Value: String);
begin
  FMesChave := Value;
