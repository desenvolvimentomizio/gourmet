...
uses
  ...
  FireDAC.Phys.SQLite,pcnConversaoNFe;
...
type
  ...
  Tdtmxml = class(TDataModule)
    ...
    XmlCfgArquivoPFX: TWideStringField;
    XmlCfgPathDB: TWideStringField;
...
begin
  ...
  Conn.Params.Database := ChangeFileExt(ParamStr(0), '.db');
...
procedure Tdtmxml.SetaConfiguracoes4;
begin
