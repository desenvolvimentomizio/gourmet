...
begin
  ...
  begin
    ...
    begin
      ...
      Textoimg := 'Ped.: ' + formatfloat('000', imm.FieldByName('immnumepedido').AsInteger);
      ...
      GeraNumeroPedido(Textoimg, extractfilepath(Application.ExeName) + 'numeros\ped' + formatfloat('000', imm.FieldByName('immnumepedido').AsInteger) + '.bmp');
    ...
    begin
      ...
      Begin
        ...
        BEGIN
          ...
          Texto.Add('                         ' + self.corcorcnome.AsString + ' ' + '#20011');
...
begin
  ...
  qclb.Close;
  qclb.sql.text := 'select clbidentificacao from clb where clbcodigo=' + self.corcclbcodigo.AsString;
  qclb.Open;
...
Function TfprinciServRest.Imprime(Texto: TStringList; Porta: Ansistring): String;
Var
  Vch: String;
  i: Integer;
  S_linha: Ansistring;
...
Procedure TfprinciServRest.GeraNumeroPedido(Texto, arquivo: string);
var
  vlArqFundo: string;
begin
