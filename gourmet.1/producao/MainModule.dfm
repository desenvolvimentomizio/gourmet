object UniMainModule: TUniMainModule
  ...
  object imm: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  LPAD( CONVERT(imm.immnumepedido, char), 5,'#39'0'#39') AS pdgnumero,'
      '  if (immrecebido='#39'1'#39','#39'>>'#39','#39'  '#39') marca,'
      ...
      '  pro.grpcodigo,'
      '  ito.procodigo,'
      '  if(imm.immnumepedido<5000,'#39'DELIVERY'#39','#39'SAL'#195'O'#39') immdestino '
      'FROM pro,'
      '     gri,'
      '     ito,'
      '     imm, '
      ...
      'and immrecebido<>2'
        ...
        'AND  if(imm.immnumepedido<5000, imm.immhoraimprimir is not null,' +
        'true) '
      ...
      'AND gri.gricontrolaproducao=1'
      'AND imm.cznchave= czn.cznchave'
      'AND imm.immhoraimprimir is not null'
      'AND cznfechamento IS null'
      'and immrecebido<>2'
      'order by imm.immchave'
      ''
