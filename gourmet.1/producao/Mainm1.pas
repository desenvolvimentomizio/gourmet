...
uses
  uniGUIVars, MainModule, uniGUIApplication, UnimFormClb{, ufImpressoras};
...
procedure TMainmForm.selecionarSetor;
begin

 { fImpressoras.ShowFormModal(
    procedure
    begin
