...
type
  ...
  private
   ...
   function AjustaPainelImpressora(const aID: String;
    ...
    procedure ConsultaImpressora(aID: String);
    procedure VerificaEstadoImpressora(aMFila:TMemo;aID:String);
...
// AjustaPainelImpressora(const aID: String;
  ///TciPorta:String; aTciCodigo:Integer; aStatus:String;  aIdentificacao:String): boolean;

procedure TfPrinciMizioServImpressoras.ConsultaImpressora(aID:String);
var
  vlID:String;
  vlTciCodigo:Integer;
  vlTciPorta:String;
...
begin
  ...
  if self.FindComponent('plImp'+vlID)<>nil then
  begin
    if self.FindComponent('plImp'+aID) is Tpanel then
    begin

      vlTciPorta:=(self.FindComponent('plImp'+aID) as Tpanel).Hint;
      vlIdentificacao:= (self.FindComponent('plImp'+aID) as Tpanel).Caption;
      vlTciCodigo :=(self.FindComponent('plImp'+aID) as Tpanel).Tag;
      vlStatusImpressora:=EstadoImpressora(vlID,self.FindComponent('ACBrPosPrinter'+vlID) as TACBrPosPrinter, vlTciPorta);
    end;
  end;
...
procedure TfPrinciMizioServImpressoras.VerificaEstadoImpressora(aMFila:TMemo;aID:String);
var
   FilaVazia:Boolean;
begin

  if aMFila.Lines.Count=0 then
    FilaVazia:=True
  else
    FilaVazia:=False ;
  ...
  if FilaVazia then
  begin
    ConsultaImpressora(aID);
  end
  else
    AjustaEstadoImpressora(aID.ToInteger);
  ...
  try
    try
      ...
      begin
        ...
        VerificaEstadoImpressora(mmFilaSalao,'1');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'1');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'2');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'2');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'3');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'3');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'4');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'4');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'5');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'5');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'6');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'6');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'7');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'7');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'8');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'8');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'9');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'9');
      end;
...
begin
  try
    try
      ...
      begin
        ProcessarFilaImpressao(mmFilaSalao, 'salao');
        VerificaEstadoImpressora(mmFilaSalao,'10');
      end
      else
      begin
        ProcessarFilaImpressao(mmFilaEntrega, 'entrega');
        VerificaEstadoImpressora(mmFilaEntrega,'10');
      end;
...
begin
  ...
  try
    ...
    procedure
      begin
         mmLogs.Lines.Add('Versão: 25.28.501.10');
...
begin
  try
    ...
    if (vlTciPorta<>'') and (vlIdentificacao<>'') then
    begin
