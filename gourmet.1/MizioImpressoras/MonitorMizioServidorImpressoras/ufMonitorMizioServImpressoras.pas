unit ufMonitorMizioServImpressoras;
...
type
  TfMonitorMizioImpressoras = class(TForm)
...
var
  fMonitorMizioImpressoras: TfMonitorMizioImpressoras;
...
procedure TfMonitorMizioImpressoras.FormShow(Sender: TObject);
begin
  OcultarInicial.Enabled := True;
end;


procedure TfMonitorMizioImpressoras.MOSTRARImpressorClick(Sender: TObject);
begin
  vpMostrar := True;
end;
...
procedure TfMonitorMizioImpressoras.OCULTARImpressorClick(Sender: TObject);
begin
  vpMostrar := False;
end;

procedure TfMonitorMizioImpressoras.OcultarInicialTimer(Sender: TObject);
begin
...
Function TfMonitorMizioImpressoras.VerificaProgramaRodando:boolean;
var
  MonitorPath: string;
  ProcessPath: string;
  List: TStringList;
...
procedure TfMonitorMizioImpressoras.ExecutaPrograma;
begin
...
procedure TfMonitorMizioImpressoras.relagioServidorImpressorasTimer(Sender: TObject);
begin
...
Procedure TfMonitorMizioImpressoras.RunOnStartup(sProgTitle, sCmdLine: String);
Var
  sKey: String;
  Reg: TRegIniFile;
Begin
...
procedure TfMonitorMizioImpressoras.FecharClick(Sender: TObject);
begin
...
procedure TfMonitorMizioImpressoras.FormCreate(Sender: TObject);
begin
