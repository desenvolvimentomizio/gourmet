...
type TStoneTEF = class
    ...
    const
     RETURN_SCHEME                         = 'stone-DTDemo1';
     RETURN_SCHEME_CANCEL                  = 'stone-DTDemo1-cancel';
    ...
    published
     ...
     property installment_count   : string       read Finstallment_count   write Finstallment_count;
  ...
  begin
    ...
    begin
      ...
      begin
            ...
            Finstallment_count := ResponseURI.ParameterByName['installment_count'];
      end else begin
